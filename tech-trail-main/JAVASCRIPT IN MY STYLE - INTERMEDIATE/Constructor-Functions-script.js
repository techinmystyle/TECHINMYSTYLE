...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Constructor Functions</code> in JavaScript are special functions used with the <code>new</code> keyword to create and initialize objects, setting up properties and methods for new instances. They're commonly used for object creation patterns, prototype-based inheritance, creating multiple similar objects, encapsulating initialization logic, or implementing object-oriented programming concepts before ES6 classes.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Constructor Function Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="constructor-container">\n    <h1>Constructor Function Demo</h1>\n    <button class="constructor-btn" onclick="useConstructor()">Run Constructor</button>\n    <p id="constructor-result"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: sans-serif;\n  background-color: #e0f2fe;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.constructor-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\n.constructor-container h1 {\n  margin-bottom: 1rem;\n  color: #075985;\n}\n\n.constructor-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #0ea5e9;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.constructor-btn:hover {\n  background-color: #0284c7;\n}\n\n#constructor-result {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #0369a1;\n}',

  js: '// Constructor Function Example\nfunction Person(name, age) {\n  this.name = name;\n  this.age = age;\n  this.greet = function() {\n    return `Hi, I am ${this.name} and I am ${this.age} years old.`;\n  };\n}\n\nfunction useConstructor() {\n  const person1 = new Person("Alice", 25);\n  const message = person1.greet();\n  document.getElementById("constructor-result").textContent = message;\n  console.log("Constructor function used:", message);\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("Constructor function demo is ready.");\n});'
};

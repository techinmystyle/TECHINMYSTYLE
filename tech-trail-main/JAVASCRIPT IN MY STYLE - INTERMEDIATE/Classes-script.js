...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Classes</code> in JavaScript are syntactic sugar over prototype-based inheritance, providing a cleaner way to create objects and implement inheritance using constructor functions, methods, and properties. They're commonly used for object-oriented programming, code organization, inheritance hierarchies, encapsulation, or creating reusable blueprints for similar objects.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Class Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="class-container">\n    <h1>JavaScript Class Demo</h1>\n    <button class="class-btn" onclick="runClassExample()">Create Object</button>\n    <p id="class-result"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #ede9fe;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.class-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\n.class-container h1 {\n  margin-bottom: 1rem;\n  color: #4c1d95;\n}\n\n.class-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #7c3aed;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.class-btn:hover {\n  background-color: #6b21a8;\n}\n\n#class-result {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #581c87;\n}',

  js: '// JavaScript class example\nclass Person {\n  constructor(name, age) {\n    this.name = name;\n    this.age = age;\n  }\n\n  greet() {\n    return `Hi, I am ${this.name} and I am ${this.age} years old.`;\n  }\n}\n\nfunction runClassExample() {\n  const student = new Person("Ram", 20);\n  document.getElementById("class-result").textContent = student.greet();\n  console.log("Class used to create:", student);\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("Class demo is ready.");\n});'
};

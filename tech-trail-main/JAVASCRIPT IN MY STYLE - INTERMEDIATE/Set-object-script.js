...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Set Object</code> in JavaScript is a built-in collection that stores unique values of any type, providing methods like <code>add()</code>, <code>delete()</code>, <code>has()</code>, and <code>clear()</code> to manage collections where duplicate values are automatically prevented. It's commonly used for removing duplicates from arrays, tracking unique items, implementing mathematical set operations, managing collections of unique identifiers, or creating efficient lookup structures where uniqueness is required.</span>
    </p>
</div>
  `;
...
<body>
  <div class="container">
    <h1>JavaScript Set Object Demo</h1>
    <p>Click the button to see examples of the Set object usage and methods.</p>
    <button id="runBtn">Run Set Demo</button>
...
runBtn.addEventListener('click', () => {
  ...
  output += 'Added values: 1, 5, "hello", 1 (duplicate)\\n';
  output += 'Set size: ' + set.size + '\\n';

  // Check for existence
  output += 'Set has 5? ' + set.has(5) + '\\n';
  output += 'Set has "world"? ' + set.has('world') + '\\n';

  // Iterate over Set
  output += 'Iterating over Set values:\\n';
  ...
  // Delete a value
  set.delete(5);
  output += 'Deleted 5 from Set. New size: ' + set.size + '\\n';

  // Clear Set
  set.clear();
  output += 'Cleared Set. Size now: ' + set.size + '\\n';

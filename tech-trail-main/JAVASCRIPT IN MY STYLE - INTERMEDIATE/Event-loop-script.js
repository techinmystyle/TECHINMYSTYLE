...
document.addEventListener("DOMContentLoaded", () => {
  ...
  infoBanner.innerHTML = `
    <div class="flex items-start">
        ...
        <p>
            <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Event Loop</code> in JavaScript is the mechanism that handles asynchronous operations. It manages the call stack, callback queue, and microtask queue, ensuring that JavaScript remains non-blocking and can handle multiple operations efficiently.</span>
        </p>
    </div>
  `;
...
function initializeEditor() {
  ...
  const defaultCode = {
    html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Event Loop Demo</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="event-loop-container">\n    <h1>Event Loop Demo</h1>\n    <div class="button-group">\n      <button class="event-loop-btn" onclick="demonstrateEventLoop()">Start Event Loop Demo</button>\n      <button class="event-loop-btn" onclick="clearOutput()">Clear Output</button>\n    </div>\n    <div class="output-section">\n      <h3>Execution Order:</h3>\n      <pre id="event-loop-output"></pre>\n    </div>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

    css: 'body {\n  font-family: monospace;\n  background-color: #eef2ff;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  min-height: 100vh;\n}\n\n.event-loop-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  max-width: 90%;\n  width: 600px;\n}\n\n.button-group {\n  display: flex;\n  justify-content: center;\n  gap: 1rem;\n  margin: 1rem 0;\n}\n\n.event-loop-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #6366f1;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.event-loop-btn:hover {\n  background-color: #4f46e5;\n}\n\n.output-section {\n  margin-top: 1.5rem;\n  text-align: left;\n}\n\n#event-loop-output {\n  background-color: #f8f9fa;\n  padding: 1rem;\n  border-radius: 6px;\n  border: 1px solid #e9ecef;\n  color: #1e3a8a;\n  white-space: pre-wrap;\n  min-height: 200px;\n  font-size: 0.9rem;\n}',

    js: '// Event Loop Demonstration\nlet outputElement;\nlet executionOrder = [];\n\nfunction addToOutput(message, delay = 0) {\n  setTimeout(() => {\n    executionOrder.push(message);\n    updateOutput();\n  }, delay);\n}\n\nfunction updateOutput() {\n  if (outputElement) {\n    outputElement.textContent = executionOrder.join("\\n");\n  }\n}\n\nfunction demonstrateEventLoop() {\n  executionOrder = [];\n  updateOutput();\n  \n  console.log("Starting Event Loop Demo...");\n  \n  // Synchronous code\n  addToOutput("1. Synchronous: Start of script");\n  \n  // setTimeout (Macro task)\n  setTimeout(() => {\n    addToOutput("6. Macro Task: setTimeout 0ms");\n  }, 0);\n  \n  setTimeout(() => {\n    addToOutput("7. Macro Task: setTimeout 100ms");\n  }, 100);\n  \n  // Promise (Micro task)\n  Promise.resolve().then(() => {\n    addToOutput("4. Micro Task: Promise.resolve().then()");\n  });\n  \n  // Another Promise\n  new Promise((resolve) => {\n    addToOutput("2. Synchronous: Inside Promise constructor");\n    resolve();\n  }).then(() => {\n    addToOutput("5. Micro Task: Promise.then()");\n  });\n  \n  // More synchronous code\n  addToOutput("3. Synchronous: End of script");\n  \n  console.log("Event Loop Demo initiated!");\n}\n\nfunction clearOutput() {\n  executionOrder = [];\n  updateOutput();\n  console.log("Output cleared");\n}\n\n// Event listener for DOM content loaded\ndocument.addEventListener("DOMContentLoaded", () => {\n  outputElement = document.getElementById("event-loop-output");\n  console.log("Event Loop demo is ready.");\n  \n  // Add explanation text\n  executionOrder.push("Click \\"Start Event Loop Demo\\" to see the execution order!");\n  updateOutput();\n});'
  };

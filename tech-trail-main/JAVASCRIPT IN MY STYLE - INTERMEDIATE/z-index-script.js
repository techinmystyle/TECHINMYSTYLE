...
<div class="flex items-start">
  ...
  <p>
    <span><code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">z-index</code> in CSS (often accessed via JavaScript) controls the stack order of elements. A higher <code class="bg-gray-50 px-1 rounded">z-index</code> brings an element in front of others. JavaScript can modify it dynamically for modals, tooltips, and layered UI elements.</span>
  </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>z-index Demo</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="container">\n    <div class="box box1">Box 1 (z-index: 1)</div>\n    <div class="box box2">Box 2 (z-index: 3)</div>\n    <div class="box box3">Box 3 (z-index: 2)</div>\n    <button id="changeZBtn">Change z-index of Box 1</button>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #f3f4f6;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.container {\n  position: relative;\n  width: 300px;\n  height: 200px;\n}\n\n.box {\n  position: absolute;\n  width: 150px;\n  height: 100px;\n  color: white;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  font-weight: bold;\n  border-radius: 8px;\n  cursor: pointer;\n  user-select: none;\n}\n\n.box1 {\n  background-color: #ef4444;\n  top: 20px;\n  left: 20px;\n  z-index: 1;\n}\n\n.box2 {\n  background-color: #3b82f6;\n  top: 50px;\n  left: 70px;\n  z-index: 3;\n}\n\n.box3 {\n  background-color: #10b981;\n  top: 80px;\n  left: 120px;\n  z-index: 2;\n}\n\nbutton {\n  margin-top: 220px;\n  padding: 0.6rem 1.2rem;\n  background-color: #2563eb;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #1e40af;\n}',

  js: '// z-index CSS-JS Interaction Example\nconst btn = document.getElementById("changeZBtn");\nconst box1 = document.querySelector(".box1");\n\nbtn.addEventListener("click", () => {\n  // Increase z-index of box1 to be highest\n  box1.style.zIndex = "5";\n  alert("Box 1 z-index changed to 5");\n});'
};

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">GraphQL</code> is a query language and runtime for APIs that allows clients to request exactly the data they need using a single endpoint, providing strongly-typed schemas and enabling efficient data fetching with JavaScript clients. It's commonly used for API development, data fetching optimization, mobile applications, microservices communication, or building flexible APIs that allow clients to specify their exact data requirements.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>GraphQL Intro Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="graphql-container">\n    <h1>GraphQL Demo</h1>\n    <button id="fetchData">Fetch Country Info</button>\n    <pre id="output"></pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #eef2ff;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.graphql-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 20px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  width: 400px;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #6366f1;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #4f46e5;\n}\n\npre {\n  margin-top: 1rem;\n  text-align: left;\n  background-color: #f3f4f6;\n  padding: 1rem;\n  border-radius: 5px;\n  overflow-x: auto;\n}',

  js: '// GraphQL Query Example\nconst button = document.getElementById("fetchData");\nconst output = document.getElementById("output");\n\nbutton.addEventListener("click", () => {\n  const query = `\n    {\n      country(code: "IN") {\n        name\n        capital\n        currency\n      }\n    }\n  `;\n\n  fetch("https://countries.trevorblades.com/", {\n    method: "POST",\n    headers: {\n      "Content-Type": "application/json"\n    },\n    body: JSON.stringify({ query })\n  })\n    .then(res => res.json())\n    .then(data => {\n      output.textContent = JSON.stringify(data.data.country, null, 2);\n      console.log("GraphQL Data:", data);\n    })\n    .catch(err => {\n      output.textContent = "Error: " + err.message;\n      console.error(err);\n    });\n});'
};

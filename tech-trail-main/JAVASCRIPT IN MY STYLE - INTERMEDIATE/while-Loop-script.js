...
<div class="flex items-start">
  ...
  <p>
    <span><code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">while Loop</code> is a control structure that continues to execute its block as long as the specified condition evaluates to <code class="bg-gray-50 px-1 rounded">true</code>. It's commonly used when the number of iterations isn’t known beforehand.</span>
  </p>
</div>
  `;

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Script Tag</code> in JavaScript is an HTML element <code>&lt;script&gt;</code> used to embed or reference JavaScript code in web pages, supporting attributes like <code>src</code> for external files, <code>async</code> and <code>defer</code> for loading behavior, and <code>type</code> for script types. It's commonly used for including JavaScript libraries, adding interactive functionality, loading external scripts, controlling script execution timing, or embedding inline JavaScript code directly within HTML documents for web application functionality.</span>
    </p>
</div>
  `;
...
<head>
  ...
  <title>Script Tag in JavaScript</title>
  <link rel="stylesheet" href="style.css" />
</head>
<body>
  <div class="container">
    <h1>JavaScript Script Tag Demo</h1>
    <p>Demonstrates different ways to use the &lt;script&gt; tag in HTML.</p>
    
    <button id="inlineScriptBtn">Run Inline Script</button>
    <button id="externalScriptBtn">Run External Script</button>
  ...
  <!-- Inline Script -->
  <script>
    function inlineScriptExample() {
      return "Inline script executed!";
    }
  </script>
...
const inlineBtn = document.getElementById('inlineScriptBtn');
const externalBtn = document.getElementById('externalScriptBtn');

// Inline script demo
inlineBtn.addEventListener('click', () => {
  const result = inlineScriptExample();
  outputLog.textContent = 'Inline Script Output: ' + result;
});

// External script demo
externalBtn.addEventListener('click', () => {
  outputLog.textContent = 'External Script Loaded and Running!';
});`
};

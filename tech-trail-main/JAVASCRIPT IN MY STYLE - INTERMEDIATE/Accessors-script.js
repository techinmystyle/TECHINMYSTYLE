...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Accessors</code> (getters and setters) in JavaScript provide controlled access to object properties using get and set keywords. They're commonly used for data validation, computed properties, encapsulation, or triggering side effects when properties are accessed or modified.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Accessors Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="accessor-container">\n    <h1>Accessor Demo</h1>\n    <button class="accessor-btn" onclick="showUserInfo()">Show Info</button>\n    <p id="accessor-result"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #f0fdf4;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.accessor-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\n.accessor-container h1 {\n  margin-bottom: 1rem;\n  color: #15803d;\n}\n\n.accessor-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #22c55e;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.accessor-btn:hover {\n  background-color: #16a34a;\n}\n\n#accessor-result {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #166534;\n}',

  js: '// JavaScript demonstrating Accessors (getters and setters)\nclass User {\n  constructor(name, age) {\n    this._name = name;\n    this._age = age;\n  }\n\n  get name() {\n    return this._name.toUpperCase();\n  }\n\n  set age(value) {\n    if (value >= 0) {\n      this._age = value;\n    } else {\n      console.warn("Invalid age");\n    }\n  }\n\n  get age() {\n    return `${this._age} years old`;\n  }\n}\n\nfunction showUserInfo() {\n  const user = new User("Basha", 19);\n  user.age = 20;\n  document.getElementById("accessor-result").textContent = `Name: ${user.name}, Age: ${user.age}`;\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("Accessor demo is ready.");\n});'

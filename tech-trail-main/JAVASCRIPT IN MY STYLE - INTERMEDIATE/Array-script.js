...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Array</code> object in JavaScript represents an ordered collection of elements with dynamic size and various built-in methods. It's commonly used for storing lists of data, iterating through collections, manipulating datasets, or organizing multiple values in a single variable.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Array Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="array-container">\n    <h1>Array Demo</h1>\n    <button class="array-btn" onclick="showArray()">Show Array</button>\n    <p id="array-result"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #ecfdf5;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.array-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\n.array-container h1 {\n  margin-bottom: 1rem;\n  color: #065f46;\n}\n\n.array-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #10b981;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.array-btn:hover {\n  background-color: #059669;\n}\n\n#array-result {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #065f46;\n}',

  js: '// JavaScript Array Example\nfunction showArray() {\n  const fruits = ["Apple", "Banana", "Cherry", "Mango"];\n  const result = fruits.join(", ");\n  document.getElementById("array-result").textContent = "Fruits: " + result;\n  console.log("Array contents:", fruits);\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("Array demo is ready.");\n});'
};

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Rounding Numbers</code> in JavaScript involves methods like <code>Math.round()</code>, <code>Math.floor()</code>, <code>Math.ceil()</code>, and <code>toFixed()</code> to control decimal precision and convert floating-point numbers to integers or specific decimal places. It's commonly used for financial calculations, display formatting, mathematical operations, data processing, or ensuring consistent number presentation in user interfaces where precise decimal control is required for accuracy and readability.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Rounding Numbers</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="rounding-container">\n    <h1>Rounding Numbers in JavaScript</h1>\n    <input type="number" id="numberInput" step="0.01" placeholder="Enter a decimal number">\n    <button id="roundBtn">Round</button>\n    <div id="output"></div>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #ecfeff;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.rounding-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  max-width: 400px;\n}\n\ninput {\n  padding: 0.5rem;\n  font-size: 1rem;\n  width: 80%;\n  margin-bottom: 1rem;\n  border: 1px solid #ccc;\n  border-radius: 5px;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #06b6d4;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #0891b2;\n}\n\n#output {\n  margin-top: 1.5rem;\n  font-weight: bold;\n  color: #0f172a;\n}',

  js: '// Rounding Numbers Example\nconst button = document.getElementById("roundBtn");\nconst input = document.getElementById("numberInput");\nconst output = document.getElementById("output");\n\nbutton.addEventListener("click", () => {\n  const value = parseFloat(input.value);\n  if (isNaN(value)) {\n    output.textContent = "Please enter a valid number.";\n    return;\n  }\n\n  const rounded = Math.round(value);\n  const floored = Math.floor(value);\n  const ceiled = Math.ceil(value);\n\n  output.innerHTML = `\n    <p><strong>Original:</strong> ${value}</p>\n    <p><strong>Math.round:</strong> ${rounded}</p>\n    <p><strong>Math.floor:</strong> ${floored}</p>\n    <p><strong>Math.ceil:</strong> ${ceiled}</p>\n  `;\n});'
};

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">MutationObserver</code> in JavaScript is a Web API that provides the ability to watch for changes in the DOM tree, including modifications to elements, attributes, or text content, and execute callback functions when mutations occur. It's commonly used for monitoring DOM changes, implementing reactive systems, building developer tools, creating custom frameworks, or detecting when third-party scripts modify the page structure for responsive applications.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>MutationObserver Demo</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="observer-container">\n    <h1>MutationObserver Example</h1>\n    <button id="changeBtn">Change Text</button>\n    <p id="observedText">Original text</p>\n    <p id="log">Waiting for changes...</p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #f0fdfa;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.observer-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 12px;\n  box-shadow: 0 6px 15px rgba(0,0,0,0.1);\n  text-align: center;\n  width: 320px;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #22c55e;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  font-size: 1rem;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #16a34a;\n}\n\n#log {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #166534;\n}',

  js: '// MutationObserver Example\nconst observedText = document.getElementById("observedText");\nconst log = document.getElementById("log");\nconst changeBtn = document.getElementById("changeBtn");\n\n// Create an observer instance linked to the callback function\nconst observer = new MutationObserver((mutationsList) => {\n  for (const mutation of mutationsList) {\n    if (mutation.type === "childList") {\n      log.textContent = "Text content changed!";\n    }\n  }\n});\n\n// Start observing the target node for configured mutations\nobserver.observe(observedText, { childList: true });\n\n// Button to change the observed text\nchangeBtn.addEventListener("click", () => {\n  observedText.textContent = "Text has been changed!";\n});'
};

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">AJAX</code> (Asynchronous JavaScript and XML) technique allows web pages to update content dynamically without full page reloads. It's commonly used for fetching data from servers, submitting forms asynchronously, creating interactive user interfaces, or building single-page applications.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>AJAX Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="ajax-container">\n    <h1>AJAX Demo</h1>\n    <button class="ajax-btn" onclick="loadData()">Fetch Data</button>\n    <p id="ajax-result"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #f0f9ff;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.ajax-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\n.ajax-container h1 {\n  margin-bottom: 1rem;\n  color: #0c4a6e;\n}\n\n.ajax-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #0284c7;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.ajax-btn:hover {\n  background-color: #0369a1;\n}\n\n#ajax-result {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #075985;\n}',

  js: '// JavaScript demonstrating AJAX using XMLHttpRequest\nfunction loadData() {\n  const xhr = new XMLHttpRequest();\n  xhr.open("GET", "https://jsonplaceholder.typicode.com/users/1", true);\n\n  xhr.onload = function () {\n    if (xhr.status === 200) {\n      const user = JSON.parse(xhr.responseText);\n      document.getElementById("ajax-result").textContent = `User: ${user.name}, Email: ${user.email}`;\n      console.log("User data:", user);\n    } else {\n      document.getElementById("ajax-result").textContent = "Failed to load data.";\n      console.error("Error status:", xhr.status);\n    }\n  };\n\n  xhr.onerror = function () {\n    document.getElementById("ajax-result").textContent = "Request error occurred.";\n    console.error("Network error occurred.");\n  };\n\n  xhr.send();\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("AJAX demo is ready.");\n});'

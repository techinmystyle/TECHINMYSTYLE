...
<div class="flex items-start">
  ...
  <p>
    <span><code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Watchers</code> are used in frameworks like Vue.js and JavaScript features like Proxies to monitor changes to data properties and execute functions in response. They’re useful for tracking reactive data and implementing automatic updates.</span>
  </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Watchers Example (Proxy)</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="watcher-container">\n    <h1>Proxy Watcher Demo</h1>\n    <button id="changeBtn">Change Data</button>\n    <pre id="output">Click the button to trigger watcher.</pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #fff7ed;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.watcher-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  max-width: 600px;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #f97316;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n  margin-top: 1rem;\n}\n\nbutton:hover {\n  background-color: #c2410c;\n}\n\n#output {\n  margin-top: 1rem;\n  font-family: monospace;\n  background-color: #ffedd5;\n  padding: 1rem;\n  border-radius: 5px;\n  color: #9a3412;\n  white-space: pre-wrap;\n}',

  js: '// Proxy Watcher Example\nconst data = { name: "Alice", age: 25 };\nconst output = document.getElementById("output");\nconst button = document.getElementById("changeBtn");\n\nconst handler = {\n  set(target, property, value) {\n    output.textContent = `Property "${property}" changed from ${target[property]} to ${value}`;\n    target[property] = value;\n    return true;\n  }\n};\n\nconst proxyData = new Proxy(data, handler);\n\nbutton.addEventListener("click", () => {\n  // Change a property to trigger the watcher\n  proxyData.age += 1;\n});'
};

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Typed Arrays</code> in JavaScript provide a way to work with binary data in raw memory buffers using array-like views such as <code class="bg-gray-50 px-1 rounded">Uint8Array</code> or <code class="bg-gray-50 px-1 rounded">Float32Array</code>. They are useful for handling binary files, manipulating audio/video data, interacting with WebGL, and performing performance-critical operations on numeric data.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Typed Arrays Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="typed-array-container">\n    <h1>Typed Arrays in JavaScript</h1>\n    <button id="fillBtn">Fill and Display Array</button>\n    <pre id="output"></pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #fefce8;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.typed-array-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 6px 12px rgba(0,0,0,0.1);\n  text-align: center;\n  width: 400px;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #ca8a04;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #a16207;\n}\n\n#output {\n  margin-top: 1rem;\n  font-family: monospace;\n  background-color: #fff7ed;\n  padding: 1rem;\n  border-radius: 5px;\n  color: #78350f;\n}',

  js: `// Typed Arrays Example

const button = document.getElementById("fillBtn");
const output = document.getElementById("output");

button.addEventListener("click", () => {
  // Create a typed array of 10 integers
  const intArray = new Uint8Array(10);

  // Fill it with values (0 to 9)
  for (let i = 0; i < intArray.length; i++) {
    intArray[i] = i;
  }

  output.textContent = "Typed Array (Uint8Array):\\n[" + intArray.join(", ") + "]";
});
`
};

...
<div class="flex items-start">
    ...
    <p>
        <span><code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Vanilla JS</code> refers to plain JavaScript, without using any frameworks or libraries like React or jQuery. It focuses on using the core language features and the native browser API to build fast, lightweight, and framework-free web applications.</span>
    </p>
</div>
  `;

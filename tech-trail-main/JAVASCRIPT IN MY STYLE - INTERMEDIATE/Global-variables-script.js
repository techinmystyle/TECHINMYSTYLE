...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Global Variables</code> in JavaScript are variables declared outside of any function or block scope, making them accessible from anywhere in the program and automatically becoming properties of the global object (window in browsers). They're commonly used for application configuration, shared state, constants, utility functions, or data that needs to be accessed across multiple functions and modules, though they should be used sparingly to avoid naming conflicts.</span>
    </p>
</div>
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Global Variables Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="global-container">\n    <h1>Global Variable Demo</h1>\n    <button id="updateBtn">Update Global Variable</button>\n    <p id="output"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #f0fdf4;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.global-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #22c55e;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #16a34a;\n}\n\n#output {\n  margin-top: 1rem;\n  color: #15803d;\n  font-weight: bold;\n}',

  js: '// Global Variable Example\nlet globalCounter = 0; // Global variable\n\nconst button = document.getElementById("updateBtn");\nconst output = document.getElementById("output");\n\nfunction updateCounter() {\n  globalCounter++;\n  output.textContent = `Global Counter: ${globalCounter}`;\n  console.log("Updated globalCounter to", globalCounter);\n}\n\nbutton.addEventListener("click", updateCounter);\n\n// Initial message\noutput.textContent = `Global Counter: ${globalCounter}`;'
};

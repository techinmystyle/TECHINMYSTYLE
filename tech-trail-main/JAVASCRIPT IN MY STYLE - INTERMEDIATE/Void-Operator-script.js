...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Void Operator</code> in JavaScript is used to evaluate an expression and return <code class="bg-gray-50 px-1 rounded">undefined</code>. It is often used in bookmarklets or to prevent default link behavior like <code class="bg-gray-50 px-1 rounded">javascript:void(0)</code>, ensuring no value is returned or action triggered.</span>
    </p>
</div>
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Void Operator Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="void-container">\n    <h1>JavaScript void Operator</h1>\n    <button id="runBtn">Run Example</button>\n    <pre id="output">Click to see what void does.</pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #f0f9ff;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.void-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #0ea5e9;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n  margin-top: 1rem;\n}\n\nbutton:hover {\n  background-color: #0284c7;\n}\n\n#output {\n  margin-top: 1rem;\n  font-family: monospace;\n  background-color: #e0f2fe;\n  padding: 1rem;\n  border-radius: 5px;\n  color: #075985;\n  white-space: pre-wrap;\n}',

  js: '// Void Operator Example\nconst button = document.getElementById("runBtn");\nconst output = document.getElementById("output");\n\nbutton.addEventListener("click", () => {\n  const result = void(123 + 456);\n  output.textContent = "void(123 + 456) = " + result + "\\n";\n  output.textContent += "The void operator returns undefined regardless of the expression.";\n});'
};

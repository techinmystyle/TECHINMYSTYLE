...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Logical Operators</code> in JavaScript are operators that perform logical operations on boolean values or expressions, including AND (<code>&&</code>), OR (<code>||</code>), and NOT (<code>!</code>), with short-circuit evaluation that can return non-boolean values. They're commonly used for conditional logic, default value assignment, input validation, control flow, or combining multiple conditions in if statements and boolean expressions throughout applications.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Logical Operators Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="logic-container">\n    <h1>Logical Operators Demo</h1>\n    <button id="runBtn">Run Example</button>\n    <pre id="output"></pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #fefce8;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.logic-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 12px;\n  box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  width: 400px;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #f59e0b;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  font-size: 1rem;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #d97706;\n}\n\npre {\n  margin-top: 1rem;\n  background-color: #fef3c7;\n  padding: 1rem;\n  border-radius: 8px;\n  white-space: pre-wrap;\n  text-align: left;\n}',

  js: '// Logical Operators Example\nconst button = document.getElementById("runBtn");\nconst output = document.getElementById("output");\n\nbutton.addEventListener("click", () => {\n  let a = true;\n  let b = false;\n\n  output.textContent = "";\n  output.textContent += `a = ${a}, b = ${b}\\n\\n`;\n\n  output.textContent += `AND (a && b): ${a && b}\\n`;\n  output.textContent += `OR (a || b): ${a || b}\\n`;\n  output.textContent += `NOT (!a): ${!a}\\n`;\n  output.textContent += `NOT (!b): ${!b}\\n`;\n\n  output.textContent += `\\nMore Examples:\\n`;\n  output.textContent += `(5 > 3 && 10 < 20): ${(5 > 3 && 10 < 20)}\\n`;\n  output.textContent += `(5 < 3 || 10 > 20): ${(5 < 3 || 10 > 20)}\\n`;\n});'
};

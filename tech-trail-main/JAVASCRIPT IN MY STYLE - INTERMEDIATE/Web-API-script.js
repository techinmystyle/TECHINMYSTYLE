...
<div class="flex items-start">
  ...
  <p>
    <span><code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Web APIs</code> are built-in browser features (like DOM, Fetch, Geolocation, and Canvas APIs) that allow developers to interact with browser functionalities or the web environment, extending JavaScript's capabilities beyond the core language.</span>
  </p>
</div>

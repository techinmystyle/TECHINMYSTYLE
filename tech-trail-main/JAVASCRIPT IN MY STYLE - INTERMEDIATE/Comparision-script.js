...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Comparison Operators</code> in JavaScript are used to compare values and return boolean results, including equality (<code>==</code>, <code>===</code>), inequality (<code>!=</code>, <code>!==</code>), and relational operators (<code>&lt;</code>, <code>&gt;</code>, <code>&lt;=</code>, <code>&gt;=</code>). They're commonly used for conditional statements, data validation, sorting algorithms, filtering operations, or any scenario requiring value comparison and decision-making logic.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Comparison Operators</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="comparison-container">\n    <h1>Comparison Operators Demo</h1>\n    <button class="comparison-btn" onclick="showComparisonResults()">Compare Values</button>\n    <pre id="comparison-result"></pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: sans-serif;\n  background-color: #fff7ed;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.comparison-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  max-width: 90%;\n}\n\n.comparison-container h1 {\n  margin-bottom: 1rem;\n  color: #92400e;\n}\n\n.comparison-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #ea580c;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.comparison-btn:hover {\n  background-color: #c2410c;\n}\n\n#comparison-result {\n  margin-top: 1rem;\n  text-align: left;\n  color: #7c2d12;\n  white-space: pre-wrap;\n}',

  js: '// Comparison Operators Example\nfunction showComparisonResults() {\n  const a = 5;\n  const b = "5";\n\n  const results = `a == b : ${a == b}\na === b : ${a === b}\na != b : ${a != b}\na !== b : ${a !== b}\na > 3 : ${a > 3}\na < 10 : ${a < 10}\na >= 5 : ${a >= 5}\na <= 4 : ${a <= 4}`;\n\n  document.getElementById("comparison-result").textContent = results;\n  console.log("Comparison operators evaluated:", results);\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("Comparison operators demo ready.");\n});'
};

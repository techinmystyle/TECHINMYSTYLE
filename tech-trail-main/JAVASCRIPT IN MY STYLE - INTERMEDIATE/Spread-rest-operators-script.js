...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Spread / Rest Operators</code> in JavaScript use the same three-dot syntax (<code>...</code>) but serve opposite purposes: the spread operator expands arrays, objects, or iterables into individual elements, while the rest operator collects multiple elements into an array or object. They're commonly used for array/object copying, function parameters, destructuring assignments, merging data structures, or creating flexible functions that can handle variable numbers of arguments.</span>
    </p>
</div>
  `;

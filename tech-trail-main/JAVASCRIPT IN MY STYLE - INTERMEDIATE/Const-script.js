...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">const</code> keyword in JavaScript declares block-scoped variables that cannot be reassigned after initialization, though objects and arrays declared with <code>const</code> can still have their contents modified. It's commonly used for configuration values, function declarations, imported modules, API endpoints, or any value that should remain constant throughout its scope.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>const Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="const-container">\n    <h1>const Demo</h1>\n    <button class="const-btn" onclick="showConstUsage()">Run const Example</button>\n    <p id="const-result"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: sans-serif;\n  background-color: #ecfccb;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.const-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\n.const-container h1 {\n  margin-bottom: 1rem;\n  color: #365314;\n}\n\n.const-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #65a30d;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.const-btn:hover {\n  background-color: #4d7c0f;\n}\n\n#const-result {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #3f6212;\n}',

  js: '// const keyword usage\nfunction showConstUsage() {\n  const pi = 3.14159;\n  const message = `The value of pi is ${pi}`;\n  document.getElementById("const-result").textContent = message;\n  console.log("const value shown:", message);\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("const demo is ready.");\n});'
};

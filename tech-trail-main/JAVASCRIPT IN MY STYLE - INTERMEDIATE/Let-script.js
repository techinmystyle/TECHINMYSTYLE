...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">let</code> keyword in JavaScript is used to declare block-scoped variables that can be reassigned but cannot be redeclared in the same scope, providing better scoping behavior than <code>var</code> by preventing hoisting issues and temporal dead zone errors. It's commonly used for loop counters, temporary variables, conditional declarations, or any scenario requiring mutable variables with predictable block-level scoping that doesn't leak outside their intended scope.</span>
    </p>
</div>
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>let Keyword Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="let-container">\n    <h1>let Keyword Demo</h1>\n    <button id="runBtn">Run let Example</button>\n    <pre id="output"></pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #f0fdf4;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.let-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 12px;\n  box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  width: 400px;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #22c55e;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  font-size: 1rem;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #16a34a;\n}\n\npre {\n  margin-top: 1rem;\n  text-align: left;\n  background-color: #f9fafb;\n  padding: 1rem;\n  border-radius: 8px;\n  white-space: pre-wrap;\n}',

  js: '// let Keyword Example\nconst button = document.getElementById("runBtn");\nconst output = document.getElementById("output");\n\nbutton.addEventListener("click", () => {\n  output.textContent = "";\n\n  let message = "This is declared using let";\n  output.textContent += message + "\\n";\n\n  let number = 10;\n  output.textContent += "Initial value: " + number + "\\n";\n\n  number = 20;\n  output.textContent += "Updated value: " + number + "\\n";\n\n  {\n    let blockScoped = "I exist only in this block";\n    output.textContent += blockScoped + "\\n";\n  }\n\n  try {\n    output.textContent += blockScoped; // ReferenceError\n  } catch (e) {\n    output.textContent += "Error: blockScoped is not accessible outside its block.\\n";\n  }\n});'
};

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Inheritance</code> in JavaScript is an object-oriented programming concept that allows objects or classes to inherit properties and methods from parent objects or classes, implemented through prototypes or ES6 class syntax with <code>extends</code> and <code>super</code> keywords. It's commonly used for code reusability, creating object hierarchies, implementing polymorphism, extending functionality, or building modular systems where child classes can inherit and override parent behavior.</span>
    </p>
</div>
  `;

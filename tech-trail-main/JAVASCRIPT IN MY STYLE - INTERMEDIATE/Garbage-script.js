...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Garbage Collection</code> in JavaScript is an automatic memory management process that identifies and frees memory occupied by objects that are no longer reachable or referenced in the program, using algorithms like mark-and-sweep to prevent memory leaks. It's commonly used for memory optimization, preventing memory leaks, performance management, or understanding how JavaScript engines automatically handle memory allocation and deallocation in applications.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Garbage Collection in JavaScript</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="gc-container">\n    <h1>Garbage Collection Demo</h1>\n    <button id="allocateBtn">Allocate Object</button>\n    <button id="deallocateBtn">Deallocate Object</button>\n    <p id="logMessage">Status: No object created yet.</p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: sans-serif;\n  background-color: #e0f7fa;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.gc-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 0 10px rgba(0, 0, 0, 0.2);\n  text-align: center;\n}\n\nbutton {\n  margin: 0.5rem;\n  padding: 0.6rem 1.2rem;\n  font-size: 1rem;\n  background-color: #00bcd4;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #008ba3;\n}\n\n#logMessage {\n  margin-top: 1rem;\n  color: #006064;\n  font-weight: bold;\n}',

  js: '// Demonstration of Garbage Collection\nlet tempObject = null;\n\nconst log = document.getElementById("logMessage");\nconst allocateBtn = document.getElementById("allocateBtn");\nconst deallocateBtn = document.getElementById("deallocateBtn");\n\nallocateBtn.addEventListener("click", () => {\n  tempObject = {\n    name: "Memory Object",\n    data: new Array(1000000).fill("data")\n  };\n  log.textContent = "Status: Object allocated in memory.";\n  console.log("Allocated:", tempObject);\n});\n\ndeallocateBtn.addEventListener("click", () => {\n  tempObject = null;\n  log.textContent = "Status: Object reference removed (eligible for GC).";\n  console.log("Reference removed. Now garbage collector can clean it.");\n});'
};

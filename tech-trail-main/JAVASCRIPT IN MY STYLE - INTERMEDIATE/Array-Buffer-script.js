...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">ArrayBuffer</code> object in JavaScript represents a fixed-length raw binary data buffer. It's commonly used for handling binary data, working with typed arrays, processing files, or interfacing with WebGL and other APIs that require low-level data manipulation.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>ArrayBuffer Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="arraybuffer-container">\n    <h1>ArrayBuffer Demo</h1>\n    <button class="arraybuffer-btn" onclick="useArrayBuffer()">Use ArrayBuffer</button>\n    <p id="buffer-result"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #f0f9ff;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.arraybuffer-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\n.arraybuffer-container h1 {\n  margin-bottom: 1rem;\n  color: #0369a1;\n}\n\n.arraybuffer-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #0ea5e9;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.arraybuffer-btn:hover {\n  background-color: #0284c7;\n}\n\n#buffer-result {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #075985;\n}',

  js: '// JavaScript ArrayBuffer Example\nfunction useArrayBuffer() {\n  const buffer = new ArrayBuffer(8); // 8 bytes\n  const view = new Uint32Array(buffer);\n  view[0] = 12345;\n  view[1] = 67890;\n\n  const result = `Values: ${view[0]}, ${view[1]}`;\n  document.getElementById("buffer-result").textContent = result;\n  console.log("ArrayBuffer data:", view);\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("ArrayBuffer demo is ready.");\n});'
};

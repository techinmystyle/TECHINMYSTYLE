...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">instanceof</code> operator in JavaScript tests whether an object is an instance of a specific constructor or class by checking if the constructor's prototype appears anywhere in the object's prototype chain. It's commonly used for type checking, polymorphism, error handling, object validation, or determining the specific type of objects in inheritance hierarchies and class-based programming patterns.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>instanceof Demo</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="instanceof-container">\n    <h1>instanceof Example</h1>\n    <button id="checkBtn">Check Instance</button>\n    <p id="result"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #fef9c3;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.instanceof-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 12px;\n  box-shadow: 0 6px 12px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  width: 300px;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #facc15;\n  color: black;\n  border: none;\n  border-radius: 6px;\n  font-size: 1rem;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #eab308;\n}\n\n#result {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #854d0e;\n}',

  js: '// instanceof Example\nclass Animal {\n  constructor(name) {\n    this.name = name;\n  }\n}\n\nconst dog = new Animal("Buddy");\n\nconst button = document.getElementById("checkBtn");\nconst result = document.getElementById("result");\n\nbutton.addEventListener("click", () => {\n  if (dog instanceof Animal) {\n    result.textContent = "dog is an instance of Animal.";\n  } else {\n    result.textContent = "dog is NOT an instance of Animal.";\n  }\n});'
};

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Regex (Regular Expressions)</code> in JavaScript are patterns used to match character combinations in strings, created using literal notation <code>/pattern/flags</code> or the RegExp constructor, providing methods like <code>test()</code>, <code>match()</code>, and <code>replace()</code> for string manipulation. They're commonly used for input validation, text parsing, search and replace operations, data extraction, form validation, or pattern matching tasks where you need to find, validate, or manipulate specific text patterns within strings.</span>
    </p>
</div>
  `;

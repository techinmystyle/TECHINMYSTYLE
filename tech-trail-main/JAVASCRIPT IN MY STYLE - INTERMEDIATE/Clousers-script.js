...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Closures</code> in JavaScript are functions that have access to variables from their outer (enclosing) scope even after the outer function has finished executing. They're commonly used for data privacy, module patterns, function factories, event handlers, or creating functions that remember and maintain state between calls.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Closure Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="closure-container">\n    <h1>JavaScript Closures Demo</h1>\n    <button class="closure-btn" onclick="runClosureExample()">Use Closure</button>\n    <p id="closure-result"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #e0f7fa;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.closure-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\n.closure-container h1 {\n  margin-bottom: 1rem;\n  color: #006064;\n}\n\n.closure-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #00acc1;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.closure-btn:hover {\n  background-color: #00838f;\n}\n\n#closure-result {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #004d40;\n}',

  js: '// Closure Example in JavaScript\nfunction createCounter() {\n  let count = 0;\n  return function () {\n    count++;\n    return `You clicked ${count} time(s)`;\n  };\n}\n\nconst counter = createCounter();\n\nfunction runClosureExample() {\n  const message = counter();\n  document.getElementById("closure-result").textContent = message;\n  console.log("Closure called:", message);\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("Closure demo is ready.");\n});'
};

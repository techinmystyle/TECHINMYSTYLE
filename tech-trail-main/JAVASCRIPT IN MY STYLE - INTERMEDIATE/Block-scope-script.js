...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Block Scope</code> in JavaScript refers to the accessibility of variables declared with <code>let</code> and <code>const</code> within curly braces <code>{'{}'}</code>. It's commonly used for variable encapsulation, preventing variable hoisting issues, creating temporary scopes in loops, or controlling variable lifetime within specific code blocks.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Block Scope Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="blockscope-container">\n    <h1>Block Scope Demo</h1>\n    <button class="blockscope-btn" onclick="showBlockScope()">Check Scope</button>\n    <p id="blockscope-result"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: sans-serif;\n  background-color: #f3f4f6;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.blockscope-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\n.blockscope-container h1 {\n  margin-bottom: 1rem;\n  color: #1e3a8a;\n}\n\n.blockscope-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #3b82f6;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.blockscope-btn:hover {\n  background-color: #2563eb;\n}\n\n#blockscope-result {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #1e40af;\n}',

  js: '// Demonstrate block scope using let\nfunction showBlockScope() {\n  let message = "";\n\n  if (true) {\n    let blockScoped = "I am inside the block";\n    message = blockScoped;\n  }\n\n  try {\n    // Trying to access blockScoped outside the block\n    console.log(blockScoped);\n  } catch (error) {\n    message += "\\nError: " + error.message;\n  }\n\n  document.getElementById("blockscope-result").textContent = message;\n  console.log("Block Scope checked.");\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("Block Scope demo is ready.");\n});'
};

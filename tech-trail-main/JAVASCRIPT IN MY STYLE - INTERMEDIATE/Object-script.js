...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Object</code> in JavaScript is a fundamental data type that stores collections of key-value pairs (properties and methods) using curly brace notation <code>{}</code> or constructor syntax, serving as the foundation for complex data structures and object-oriented programming. It's commonly used for data modeling, configuration storage, API responses, state management, or representing real-world entities with properties and behaviors in applications.</span>
    </P>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>JavaScript Object Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="object-container">\n    <h1>JavaScript Object Demo</h1>\n    <button id="showBtn">Show Object Info</button>\n    <p id="output">Click the button to display object data.</p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #f0fdf4;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.object-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 12px;\n  box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  width: 320px;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #10b981;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  font-size: 1rem;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #059669;\n}\n\n#output {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #065f46;\n}',

  js: '// JavaScript Object Example\nconst showBtn = document.getElementById("showBtn");\nconst output = document.getElementById("output");\n\nconst person = {\n  name: "Alice",\n  age: 25,\n  job: "Developer",\n  greet: function() {\n    return `Hi, I\'m ${this.name}, a ${this.job}.`;\n  }\n};\n\nshowBtn.addEventListener("click", () => {\n  output.textContent = person.greet();\n});'
};

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Key Events</code> in JavaScript are events triggered by keyboard interactions, including <code>keydown</code>, <code>keyup</code>, and <code>keypress</code> events that capture when users press, release, or type keys, providing access to key codes and modifier keys. They're commonly used for keyboard shortcuts, form navigation, game controls, accessibility features, or creating interactive applications that respond to specific key combinations and keyboard input patterns.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Key Events Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="key-container">\n    <h1>Key Events Demo</h1>\n    <input type="text" id="keyInput" placeholder="Type something..." />\n    <p id="result">Press a key</p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #f0f9ff;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.key-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 12px;\n  box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  width: 300px;\n}\n\ninput {\n  padding: 0.5rem;\n  font-size: 1rem;\n  width: 80%;\n  margin-bottom: 1rem;\n}\n\n#result {\n  font-size: 1.1rem;\n  font-weight: bold;\n  color: #0c4a6e;\n}',

  js: '// Key Events Example\nconst input = document.getElementById("keyInput");\nconst result = document.getElementById("result");\n\ninput.addEventListener("keydown", (event) => {\n  result.textContent = `Key Down: ${event.key}`;\n});\n\ninput.addEventListener("keyup", (event) => {\n  result.textContent = `Key Up: ${event.key}`;\n});\n\ninput.addEventListener("keypress", (event) => {\n  console.log(`Key Pressed: ${event.key}`); // just for log\n});'
};

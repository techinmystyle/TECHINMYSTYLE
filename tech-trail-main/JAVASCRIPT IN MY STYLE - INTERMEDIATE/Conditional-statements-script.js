...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Conditional Statements</code> in JavaScript control program flow by executing different code blocks based on specified conditions using <code>if</code>, <code>else if</code>, <code>else</code>, <code>switch</code>, and ternary operators. They're commonly used for decision-making logic, input validation, feature toggles, error handling, or any scenario requiring different actions based on varying conditions.</span>
    </p>
</div>
  `;

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">JSON</code> (JavaScript Object Notation) is a lightweight, text-based data interchange format that uses human-readable syntax to represent structured data, with JavaScript providing <code>JSON.parse()</code> and <code>JSON.stringify()</code> methods for conversion between JSON strings and JavaScript objects. It's commonly used for API communication, data storage, configuration files, data transmission, or exchanging information between web applications and servers in a standardized format.</span>
    </p>
</div>
  `;

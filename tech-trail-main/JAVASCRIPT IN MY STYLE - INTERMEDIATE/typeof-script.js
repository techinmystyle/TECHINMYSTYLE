...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="bg-teal-50 px-2 py-1 rounded mx-1 inline-block">typeof</code> operator in JavaScript returns a string indicating the data type of a variable or expression, returning values like "string", "number", "boolean", "object", "function", "undefined", or "symbol" to help determine the type of data being worked with. It's commonly used for type checking, input validation, conditional logic based on data types, debugging variable types, or implementing polymorphic functions that behave differently based on the type of arguments passed to them.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>typeof Operator Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="typeof-container">\n    <h1>JavaScript <code>typeof</code> Operator</h1>\n    <input type="text" id="inputValue" placeholder="Enter any value" />\n    <button id="checkBtn">Check Type</button>\n    <p id="output"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',
...
button.addEventListener("click", () => {
  ...
  // Try to interpret input as JSON (to get proper types like number, boolean, null, array, object)
  try {
  ...
  output.textContent = \`Type of input is: \${type}\`;
});
`
};

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Generators</code> in JavaScript are special functions defined with <code>function*</code> syntax that can pause and resume execution using <code>yield</code> statements, returning an iterator object that produces values on demand. They're commonly used for lazy evaluation, infinite sequences, asynchronous programming, memory-efficient data processing, or creating custom iterators that generate values incrementally rather than all at once.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>JavaScript Generators</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="generator-container">\n    <h1>Generator Function Demo</h1>\n    <button id="nextBtn">Next Value</button>\n    <p id="displayValue">Click the button to get values</p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: sans-serif;\n  background-color: #f0f4f8;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.generator-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  font-size: 1rem;\n  background-color: #3b82f6;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #1e40af;\n}\n\n#displayValue {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #1f2937;\n}',

  js: '// Generator Function Example\nfunction* numberGenerator() {\n  let num = 1;\n  while (true) {\n    yield num++;\n  }\n}\n\nconst gen = numberGenerator();\nconst display = document.getElementById("displayValue");\nconst nextBtn = document.getElementById("nextBtn");\n\nnextBtn.addEventListener("click", () => {\n  const result = gen.next();\n  display.textContent = `Next value: ${result.value}`;\n  console.log("Generated:", result.value);\n});'
};

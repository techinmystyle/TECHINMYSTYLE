...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Math Object</code> in JavaScript is a built-in global object that provides mathematical constants and functions like <code>Math.PI</code>, <code>Math.random()</code>, <code>Math.floor()</code>, <code>Math.max()</code>, and trigonometric functions for performing mathematical operations. It's commonly used for calculations, random number generation, rounding operations, geometric computations, or any scenario requiring mathematical functions and constants in web applications and algorithms.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Math Object Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="math-container">\n    <h1>Math Object Demo</h1>\n    <button id="showMathBtn">Show Math Results</button>\n    <pre id="output"></pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #fdf2f8;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.math-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 12px;\n  box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  width: 400px;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #db2777;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  font-size: 1rem;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #be185d;\n}\n\npre {\n  margin-top: 1rem;\n  background-color: #fce7f3;\n  padding: 1rem;\n  border-radius: 8px;\n  white-space: pre-wrap;\n  text-align: left;\n}',

  js: '// Math Object Example\nconst button = document.getElementById("showMathBtn");\nconst output = document.getElementById("output");\n\nbutton.addEventListener("click", () => {\n  let result = "";\n  result += `Math.PI: ${Math.PI}\\n`;\n  result += `Math.round(4.7): ${Math.round(4.7)}\\n`;\n  result += `Math.floor(4.7): ${Math.floor(4.7)}\\n`;\n  result += `Math.ceil(4.3): ${Math.ceil(4.3)}\\n`;\n  result += `Math.max(1, 5, 3): ${Math.max(1, 5, 3)}\\n`;\n  result += `Math.min(1, 5, 3): ${Math.min(1, 5, 3)}\\n`;\n  result += `Math.random(): ${Math.random().toFixed(4)}\\n`;\n  result += `Math.sqrt(16): ${Math.sqrt(16)}`;\n\n  output.textContent = result;\n});'
};

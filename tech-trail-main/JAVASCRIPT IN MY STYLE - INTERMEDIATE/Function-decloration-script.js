...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Function Declaration / Expression</code> in JavaScript are two ways to define functions: declarations use <code>function name() {}</code> syntax and are hoisted, while expressions assign functions to variables like <code>const name = function() {}</code> and are not hoisted. They're commonly used for code organization, reusability, modular programming, event handling, or creating different scoping and timing behaviors in JavaScript applications.</span>
    </p>
</div>

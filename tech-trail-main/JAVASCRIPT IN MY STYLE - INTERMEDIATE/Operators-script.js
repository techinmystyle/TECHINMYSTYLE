...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Operators</code> in JavaScript are symbols that perform operations on operands, including arithmetic operators (<code>+</code>, <code>-</code>, <code>*</code>, <code>/</code>), comparison operators (<code>==</code>, <code>===</code>, <code>&lt;</code>, <code>&gt;</code>), logical operators (<code>&&</code>, <code>||</code>, <code>!</code>), and assignment operators (<code>=</code>, <code>+=</code>, <code>-=</code>). They're commonly used for mathematical calculations, conditional logic, value comparisons, variable assignments, or performing various operations on data types throughout JavaScript applications.</span>
    </p>
</div>
  `;
...
btn.addEventListener("click", () => {
  ...
  const sum = num1 + num2;       // Arithmetic
  const isEqual = num1 === num2; // Comparison
  const isBothPositive = num1 > 0 && num2 > 0; // Logical

  result.innerHTML = 
    \`Sum: \${sum}<br>
    Are they equal? \${isEqual}<br>
    Are both positive? \${isBothPositive}\`;
});`
};

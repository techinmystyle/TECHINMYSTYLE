...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Guard Clauses</code> in JavaScript are early return statements that check for invalid conditions or edge cases at the beginning of functions, immediately exiting if preconditions aren't met to avoid deeply nested conditional logic. They're commonly used for input validation, error handling, code readability improvement, reducing complexity, or implementing defensive programming practices that make functions more robust and easier to understand.</span>
    </p>
</div>
  `;

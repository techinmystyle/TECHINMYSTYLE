...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Defer Attribute</code> in JavaScript is an HTML attribute that tells the browser to download the script in parallel while parsing the HTML, but execute it only after the HTML parsing is complete. It's commonly used for performance optimization, ensuring DOM availability, maintaining script execution order, reducing page load blocking, or loading non-critical JavaScript without affecting initial page rendering.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Defer Attribute Demo</title>\n  <link rel="stylesheet" href="style.css">\n  <script src="script.js" defer></script>\n</head>\n<body>\n  <div class="defer-container">\n    <h1>Defer Attribute Example</h1>\n    <p id="defer-status">Waiting for script execution...</p>\n  </div>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #eef6f9;\n  margin: 0;\n  padding: 0;\n  height: 100vh;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n.defer-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  max-width: 90%;\n}\n\n.defer-container h1 {\n  margin-bottom: 1rem;\n  color: #0369a1;\n}\n\n#defer-status {\n  margin-top: 1rem;\n  font-size: 1.2rem;\n  color: #0c4a6e;\n}',

  js: '// This script runs after the HTML is fully parsed because of "defer"\ndocument.addEventListener("DOMContentLoaded", () => {\n  document.getElementById("defer-status").textContent = "Script executed after HTML parsing (deferred).";\n  console.log("Defer attribute worked successfully.");\n});'
};

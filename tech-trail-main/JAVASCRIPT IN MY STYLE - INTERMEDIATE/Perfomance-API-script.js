...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Performance API</code> in JavaScript provides high-resolution timing information and performance metrics through methods like <code>performance.now()</code>, <code>performance.mark()</code>, and <code>performance.measure()</code> for measuring execution time and monitoring web application performance. It's commonly used for performance profiling, benchmarking code execution, measuring page load times, optimizing critical rendering paths, or creating detailed performance analytics and monitoring systems for web applications.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Performance API Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="performance-container">\n    <h1>Performance API Demo</h1>\n    <button id="measureBtn">Measure Load Time</button>\n    <p id="result">Click the button to measure performance.</p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #f3f4f6;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.performance-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  width: 320px;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #4f46e5;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  font-size: 1rem;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #4338ca;\n}\n\n#result {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #1e40af;\n}',

  js: '// Performance API Example\nconst btn = document.getElementById("measureBtn");\nconst result = document.getElementById("result");\n\nbtn.addEventListener("click", () => {\n  const timing = performance.timing;\n  const pageLoadTime = timing.loadEventEnd - timing.navigationStart;\n\n  if (pageLoadTime > 0) {\n    result.textContent = `Page loaded in ${pageLoadTime} ms.`;\n  } else {\n    result.textContent = "Page still loading or measurement not available.";\n  }\n});'
};

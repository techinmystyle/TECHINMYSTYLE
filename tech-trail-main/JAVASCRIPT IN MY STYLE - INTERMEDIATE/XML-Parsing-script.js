...
<div class="flex items-start">
  ...
  <p>
    <span><code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">XML Parsing</code> refers to reading and extracting data from XML documents. JavaScript provides tools like <code class="bg-gray-50 px-1 rounded">DOMParser</code> and <code class="bg-gray-50 px-1 rounded">XMLHttpRequest</code> to parse and manipulate XML content.</span>
  </p>
</div>

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Immutable Data</code> in JavaScript refers to data structures that cannot be changed after creation, requiring new objects or arrays to be created for any modifications, often implemented using techniques like Object.freeze(), spread operators, or libraries like Immutable.js. It's commonly used for state management, functional programming, preventing side effects, debugging, or ensuring data integrity in applications where predictable data flow is crucial.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Immutable Data Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="immutable-container">\n    <h1>Immutable Data</h1>\n    <button id="changeBtn">Change Copy</button>\n    <p id="original"></p>\n    <p id="modified"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #ecfdf5;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.immutable-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  width: 350px;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #10b981;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n  margin-bottom: 1rem;\n}\n\nbutton:hover {\n  background-color: #059669;\n}\n\np {\n  font-weight: bold;\n  color: #065f46;\n}',

  js: '// Immutable Data Example\nconst original = {\n  name: "Alice",\n  age: 25\n};\n\ndocument.getElementById("original").textContent = `Original: ${JSON.stringify(original)}`;\n\ndocument.getElementById("changeBtn").addEventListener("click", () => {\n  // Create a new copy using spread operator (immutability)\n  const modified = { ...original, age: 30 };\n  document.getElementById("modified").textContent = `Modified Copy: ${JSON.stringify(modified)}`;\n});'
};

...
<div class="flex items-start">
  ...
  <p>
    <span><code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">WeakMap</code> and <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">WeakSet</code> are collections that hold weak references to objects, allowing for automatic garbage collection. They're useful for storing metadata or temporary object tracking without preventing memory cleanup.</span>
  </p>
</div>
 `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>WeakMap & WeakSet Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="weak-container">\n    <h1>WeakMap & WeakSet Demo</h1>\n    <button id="runBtn">Run Example</button>\n    <pre id="output">Click to see how WeakMap and WeakSet work.</pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #eef2ff;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.weak-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  max-width: 600px;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #6366f1;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n  margin-top: 1rem;\n}\n\nbutton:hover {\n  background-color: #4f46e5;\n}\n\n#output {\n  margin-top: 1rem;\n  font-family: monospace;\n  background-color: #e0e7ff;\n  padding: 1rem;\n  border-radius: 5px;\n  color: #3730a3;\n  white-space: pre-wrap;\n}',

  js: '// WeakMap & WeakSet Example\nconst button = document.getElementById("runBtn");\nconst output = document.getElementById("output");\n\nbutton.addEventListener("click", () => {\n  const wm = new WeakMap();\n  const ws = new WeakSet();\n\n  let obj1 = { name: "Object1" };\n  let obj2 = { name: "Object2" };\n\n  wm.set(obj1, "Meta1");\n  ws.add(obj2);\n\n  let msg = "WeakMap has obj1? " + wm.has(obj1) + "\\n";\n  msg += "WeakSet has obj2? " + ws.has(obj2) + "\\n";\n\n  // Now remove the only strong reference to obj1 and obj2\n  obj1 = null;\n  obj2 = null;\n\n  msg += "\\nAfter nulling references:";\n  msg += "\\nobj1 and obj2 are eligible for garbage collection, though we can’t check them now.";\n\n  output.textContent = msg;\n});'
};

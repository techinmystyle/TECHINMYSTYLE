...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Tagged Template Literals</code> in JavaScript allow you to customize the behavior of template literals by pre-processing the string through a tag function. They are used for building DSLs, escaping strings, localization, or advanced formatting by parsing both the string parts and interpolated expressions before output is generated.</span>
    </p>
</div>
  `;
...
button.addEventListener("click", () => {
  const user = "Alice";
  const taskCount = 3;
  const message = highlight\`Hello, \${user}. You have \${taskCount} new tasks today.\`;

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">indexOf()</code> method in JavaScript searches for a specified element in an array or substring in a string and returns the index of the first occurrence, or -1 if not found. It's commonly used for element searching, existence checking, data validation, filtering operations, or finding the position of specific values in arrays and strings for further processing or manipulation.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>indexOf() Demo</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="indexof-container">\n    <h1>indexOf() Example</h1>\n    <input type="text" id="searchInput" placeholder="Enter item to find">\n    <button id="searchBtn">Search</button>\n    <p id="output"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #f0fdf4;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.indexof-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 6px 12px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  width: 300px;\n}\n\ninput {\n  padding: 0.5rem;\n  font-size: 1rem;\n  margin-bottom: 1rem;\n  width: 100%;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #22c55e;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #16a34a;\n}\n\n#output {\n  margin-top: 1rem;\n  color: #166534;\n  font-weight: bold;\n}',

  js: '// indexOf() Example\nconst fruits = ["apple", "banana", "mango", "orange", "grape"];\nconst input = document.getElementById("searchInput");\nconst button = document.getElementById("searchBtn");\nconst output = document.getElementById("output");\n\nbutton.addEventListener("click", () => {\n  const searchTerm = input.value.toLowerCase();\n  const index = fruits.indexOf(searchTerm);\n\n  if (index !== -1) {\n    output.textContent = `${searchTerm} found at index ${index}.`;\n  } else {\n    output.textContent = `${searchTerm} not found in the list.`;\n  }\n});'
};

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Unary Operators</code> in JavaScript operate on a single operand to produce a new value. Common unary operators include <code class="bg-gray-50 px-1 rounded">typeof</code>, <code class="bg-gray-50 px-1 rounded">delete</code>, <code class="bg-gray-50 px-1 rounded">!</code> (logical NOT), and unary <code class="bg-gray-50 px-1 rounded">+</code>/<code class="bg-gray-50 px-1 rounded">-</code>. They are often used for type checking, memory cleanup, and boolean evaluations.</span>
    </p>
</div>
  `;
...
<head>
  ...
  <title>Unary Operators Demo</title>
  <link rel="stylesheet" href="style.css" />
</head>
<body>
  <div class="container">
    <h1>Unary Operators in JavaScript</h1>
    <p>Click each button to see how different unary operators behave.</p>
    <div class="button-group">
      <button onclick="demoTypeof()">typeof</button>
      <button onclick="demoDelete()">delete</button>
      <button onclick="demoNot()">Logical NOT (!)</button>
      <button onclick="demoIncrement()">++ Increment</button>
      <button onclick="demoDecrement()">-- Decrement</button>
    </div>

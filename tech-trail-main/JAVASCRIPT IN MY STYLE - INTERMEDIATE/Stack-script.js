...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Stack (Call Stack)</code> in JavaScript is a Last-In-First-Out (LIFO) data structure that tracks function calls and their execution context, where each function call is pushed onto the stack and popped off when the function returns, managing the order of execution and variable scope. It's commonly used for understanding function execution flow, debugging recursive functions, managing memory allocation, handling error stack traces, or implementing algorithms that require LIFO data processing patterns.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Call Stack Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="stack-container">\n    <h1>JavaScript Call Stack</h1>\n    <button id="runBtn">Run Example</button>\n    <pre id="output">Click the button to simulate a call stack.</pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #fefce8;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.stack-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  max-width: 600px;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #eab308;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n  margin-top: 1rem;\n}\n\nbutton:hover {\n  background-color: #ca8a04;\n}\n\n#output {\n  margin-top: 1.5rem;\n  font-family: monospace;\n  text-align: left;\n  color: #713f12;\n  white-space: pre-wrap;\n}',

  js: '// Call Stack Example\nconst button = document.getElementById("runBtn");\nconst output = document.getElementById("output");\n\nfunction thirdFunction() {\n  output.textContent += "thirdFunction called\\n";\n}\n\nfunction secondFunction() {\n  output.textContent += "secondFunction called\\n";\n  thirdFunction();\n  output.textContent += "secondFunction finished\\n";\n}\n\nfunction firstFunction() {\n  output.textContent += "firstFunction called\\n";\n  secondFunction();\n  output.textContent += "firstFunction finished\\n";\n}\n\nbutton.addEventListener("click", () => {\n  output.textContent = \"Simulating call stack...\\n\\n\";\n  firstFunction();\n  output.textContent += \"\\nCall stack execution complete.\";\n});'
};

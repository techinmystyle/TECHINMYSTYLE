...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Lexical Scope</code> in JavaScript is a scoping mechanism where the accessibility of variables is determined by where they are declared in the code structure, with inner functions having access to variables in their outer (enclosing) scopes at the time of definition. It's commonly used for closures, private variables, module patterns, callback functions, or creating functions that maintain access to their surrounding context even when executed in different environments.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  ...
  js: '// Lexical Scope Example\nconst button = document.getElementById("runBtn");\nconst output = document.getElementById("output");\n\nbutton.addEventListener("click", () => {\n  output.textContent = "";\n\n  let outerVar = "I am outside";\n\n  function outerFunction() {\n    let innerVar = "I am inside outerFunction";\n\n    function innerFunction() {\n      // Has access to both innerVar and outerVar due to lexical scope\n      output.textContent += outerVar + "\\n";\n      output.textContent += innerVar + "\\n";\n    }\n\n    innerFunction();\n  }\n\n  outerFunction();\n});'
};

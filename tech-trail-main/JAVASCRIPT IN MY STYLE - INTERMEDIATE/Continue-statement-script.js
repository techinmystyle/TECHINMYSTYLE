...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Continue Statement</code> in JavaScript skips the current iteration of a loop and jumps to the next iteration, bypassing any remaining code in the current loop cycle. It's commonly used for filtering data during iteration, skipping invalid values, conditional processing, performance optimization, or avoiding nested conditional blocks within loops.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Continue Statement Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="continue-container">\n    <h1>Continue Statement Demo</h1>\n    <button class="continue-btn" onclick="runContinueExample()">Run Example</button>\n    <p id="continue-result"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: sans-serif;\n  background-color: #ecfccb;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.continue-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\n.continue-container h1 {\n  margin-bottom: 1rem;\n  color: #365314;\n}\n\n.continue-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #65a30d;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.continue-btn:hover {\n  background-color: #4d7c0f;\n}\n\n#continue-result {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #365314;\n}',

  js: '// Continue Statement Example\nfunction runContinueExample() {\n  let result = "";\n  for (let i = 1; i <= 10; i++) {\n    if (i % 2 === 0) continue; // Skip even numbers\n    result += i + " ";\n  }\n  document.getElementById("continue-result").textContent = "Odd numbers (1 to 10): " + result.trim();\n  console.log("Continue statement used to skip even numbers.");\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("Continue statement demo is ready.");\n});'
};

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Nested Functions</code> in JavaScript are functions defined inside other functions, creating inner functions that have access to the outer function's variables and parameters through lexical scoping and closure mechanisms. They're commonly used for creating private helper functions, implementing closures, organizing code logic, creating function factories, or building modular code where inner functions serve specific purposes within their containing function's scope.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Nested Functions Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="nested-container">\n    <h1>Nested Functions Demo</h1>\n    <button id="runBtn">Run Function</button>\n    <p id="output">Click the button to run nested functions.</p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #f0fdf4;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.nested-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 12px;\n  box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  width: 320px;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #16a34a;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #15803d;\n}\n\n#output {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #14532d;\n}',

  js: '// Nested Functions Example\nconst output = document.getElementById("output");\nconst button = document.getElementById("runBtn");\n\nfunction outerFunction(name) {\n  function innerFunction() {\n    return `Hello, ${name}! This is a nested function.`;\n  }\n  return innerFunction();\n}\n\nbutton.addEventListener("click", () => {\n  const message = outerFunction("User");\n  output.textContent = message;\n});'
};

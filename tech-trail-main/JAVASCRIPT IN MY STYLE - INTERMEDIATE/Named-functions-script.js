...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Named Functions</code> in JavaScript are functions declared with a specific name using the <code>function</code> keyword, providing benefits like hoisting, self-reference capability, and clearer stack traces for debugging compared to anonymous functions. They're commonly used for reusable code blocks, event handlers, callback functions, recursive operations, or creating well-documented, maintainable code where function names provide clear intent and purpose.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Named Function Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="named-fn-container">\n    <h1>Named Functions Demo</h1>\n    <button id="greetBtn">Greet</button>\n    <p id="message"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #ecfdf5;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.named-fn-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  width: 300px;\n}\n\nbutton {\n  padding: 0.5rem 1rem;\n  background-color: #10b981;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #059669;\n}\n\n#message {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #065f46;\n}',

  js: '// Named Function Example\nconst greetBtn = document.getElementById("greetBtn");\nconst message = document.getElementById("message");\n\n// Named function declaration\nfunction greetUser() {\n  message.textContent = "Hello from a named function!";\n}\n\n// Call the named function when the button is clicked\ngreetBtn.addEventListener("click", greetUser);'
};

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="bg-green-50 px-2 py-1 rounded mx-1 inline-block">this Keyword</code> in JavaScript is a context-dependent reference that points to the object that is currently executing the code, with its value determined by how a function is called rather than where it's defined, changing based on execution context, method calls, or explicit binding. It's commonly used for object method access, event handling, constructor functions, class methods, or accessing the current execution context where the behavior of this varies between regular functions, arrow functions, and different calling patterns.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>this Keyword in JavaScript</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="this-container">\n    <h1>JavaScript <code>this</code> Keyword</h1>\n    <button id="runBtn">Run Example</button>\n    <pre id="output">Click the button to see how <code>this</code> behaves.</pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #fdf2f8;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.this-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  max-width: 600px;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #ec4899;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n  margin-top: 1rem;\n}\n\nbutton:hover {\n  background-color: #db2777;\n}\n\npre {\n  text-align: left;\n  margin-top: 1rem;\n  font-family: monospace;\n  color: #831843;\n  white-space: pre-wrap;\n}',

  js: '// this Keyword Example\nconst button = document.getElementById("runBtn");\nconst output = document.getElementById("output");\n\nconst person = {\n  name: \"Alice\",\n  regularFunction: function () {\n    return `regularFunction: Hello, my name is ${this.name}`;\n  },\n  arrowFunction: () => {\n    return `arrowFunction: Hello, my name is ${this.name}`;\n  }\n};\n\nbutton.addEventListener(\"click\", function () {\n  output.textContent = \"\";\n\n  output.textContent += person.regularFunction() + \"\\n\";\n  output.textContent += person.arrowFunction() + \"\\n\";\n\n  function globalFunction() {\n    return `globalFunction: this is ${this}`;\n  }\n\n  output.textContent += globalFunction() + \"\\n\";\n});'
};

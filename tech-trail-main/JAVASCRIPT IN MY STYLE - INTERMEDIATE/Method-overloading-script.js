...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Method Overriding / Overloading</code> in JavaScript involves overriding parent class methods in child classes to provide specialized behavior, while overloading (having multiple methods with the same name but different parameters) is simulated through parameter checking since JavaScript doesn't support true overloading. They're commonly used for polymorphism, inheritance patterns, API design, creating flexible interfaces, or building extensible class hierarchies where child classes customize parent behavior.</span>
    </p>
</div>
  `;

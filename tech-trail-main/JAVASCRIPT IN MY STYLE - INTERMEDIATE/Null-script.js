...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">null</code> in JavaScript is a primitive value that represents the intentional absence of any object value, explicitly indicating that a variable should have no value or that an object reference is empty. It's commonly used for initializing variables, resetting object references, API responses indicating missing data, conditional checks, or explicitly representing "nothing" or "empty" states in applications where undefined would be inappropriate.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Null Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="null-container">\n    <h1>Null in JavaScript</h1>\n    <button id="checkBtn">Check Variable</button>\n    <p id="result">Click the button to check the variable.</p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #fff7ed;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.null-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  width: 300px;\n}\n\nbutton {\n  padding: 0.5rem 1rem;\n  background-color: #dc2626;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #b91c1c;\n}\n\n#result {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #7c2d12;\n}',

  js: '// Null Example\nlet myVar = null; // explicitly set to null\nconst result = document.getElementById("result");\nconst btn = document.getElementById("checkBtn");\n\nbtn.addEventListener("click", () => {\n  if (myVar === null) {\n    result.textContent = "myVar is null (intentionally empty).";\n  } else {\n    result.textContent = "myVar has a value.";\n  }\n});'
};

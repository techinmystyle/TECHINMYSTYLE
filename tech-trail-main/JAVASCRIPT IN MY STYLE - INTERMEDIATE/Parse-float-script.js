...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">parseFloat()</code> function in JavaScript parses a string and returns a floating-point number, reading the string from left to right until it encounters the first non-numeric character, and handling decimal points and scientific notation. It's commonly used for converting decimal strings, processing user input with decimal values, handling financial calculations, parsing measurement data, or converting string representations of floating-point numbers for mathematical operations and precise calculations.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>parseFloat() Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="parsefloat-container">\n    <h1>parseFloat() Demo</h1>\n    <input type="text" id="floatInput" placeholder="Enter a decimal value" />\n    <button id="parseBtn">Parse Float</button>\n    <p id="output">Result will appear here.</p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #f0fdf4;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.parsefloat-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  width: 300px;\n}\n\ninput {\n  padding: 0.5rem;\n  font-size: 1rem;\n  margin-bottom: 1rem;\n  width: 80%;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #10b981;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #059669;\n}\n\n#output {\n  margin-top: 1rem;\n  color: #065f46;\n  font-weight: bold;\n}',

  js: '// parseFloat() Example\nconst parseBtn = document.getElementById("parseBtn");\nconst floatInput = document.getElementById("floatInput");\nconst output = document.getElementById("output");\n\nparseBtn.addEventListener("click", () => {\n  const userInput = floatInput.value;\n  const parsed = parseFloat(userInput);\n\n  if (isNaN(parsed)) {\n    output.textContent = "Invalid input. Cannot parse to float.";\n  } else {\n    output.textContent = `Parsed float: ${parsed}`;\n  }\n});'
};

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">parseFloat()</code> function in JavaScript parses a string and returns a floating-point number, extracting the first valid decimal number from the beginning of the string and ignoring any trailing non-numeric characters. It's commonly used for user input processing, form validation, data conversion, API response parsing, or converting string representations of decimal numbers into numeric values for mathematical operations.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>parseFloat with Calculation</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="float-container">\n    <h1>parseFloat with Calculation Demo</h1>\n    <input type="text" id="priceInput" placeholder="Enter price (e.g., 12.99)">\n    <button id="calculateBtn">Calculate 10% Tax</button>\n    <p id="result"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #e0f2fe;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.float-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 20px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\ninput {\n  padding: 0.5rem;\n  font-size: 1rem;\n  width: 200px;\n  margin-bottom: 1rem;\n  border-radius: 5px;\n  border: 1px solid #ccc;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #0ea5e9;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  cursor: pointer;\n  font-size: 1rem;\n}\n\nbutton:hover {\n  background-color: #0284c7;\n}\n\n#result {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #0284c7;\n}',

  js: '// parseFloat with calculation example\ndocument.addEventListener("DOMContentLoaded", () => {\n  const input = document.getElementById("priceInput");\n  const button = document.getElementById("calculateBtn");\n  const result = document.getElementById("result");\n\n  button.addEventListener("click", () => {\n    const inputValue = input.value.trim();\n    const price = parseFloat(inputValue);\n\n    if (!isNaN(price)) {\n      const tax = price * 0.10; // 10% tax\n      const total = price + tax;\n      result.textContent = `Price: $${price.toFixed(2)}, Tax (10%): $${tax.toFixed(2)}, Total: $${total.toFixed(2)}`;\n    } else {\n      result.textContent = "Please enter a valid price.";\n    }\n  });\n});'
};

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Arrow Functions</code> syntax in JavaScript provides a concise way to write functions using the => operator with lexical 'this' binding. They're commonly used for shorter function expressions, array methods like map and filter, callbacks, or when you need to preserve the outer scope's 'this' context.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Arrow Function Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="arrow-container">\n    <h1>Arrow Function Demo</h1>\n    <button class="arrow-btn" onclick="showArrowResult()">Run Arrow Function</button>\n    <p id="arrow-result"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #eef2ff;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.arrow-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\n.arrow-container h1 {\n  margin-bottom: 1rem;\n  color: #3730a3;\n}\n\n.arrow-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #6366f1;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.arrow-btn:hover {\n  background-color: #4f46e5;\n}\n\n#arrow-result {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #312e81;\n}',

  js: '// JavaScript Arrow Function Example\nconst addNumbers = (a, b) => a + b;\n\nfunction showArrowResult() {\n  const result = addNumbers(10, 20);\n  document.getElementById("arrow-result").textContent = "10 + 20 = " + result;\n  console.log("Arrow function result:", result);\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("Arrow Function demo is ready.");\n});'
};

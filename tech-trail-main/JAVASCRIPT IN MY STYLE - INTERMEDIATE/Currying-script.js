...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Currying</code> in JavaScript is a functional programming technique that transforms a function with multiple arguments into a sequence of functions, each taking a single argument and returning another function until all arguments are provided. It's commonly used for partial application, function composition, creating reusable utilities, configuration functions, or building specialized functions from general ones.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Currying Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="currying-container">\n    <h1>Currying Demo</h1>\n    <button onclick="runCurrying()">Run Currying</button>\n    <pre id="currying-result"></pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #f0f5ff;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.currying-container {\n  background: #ffffff;\n  padding: 2rem;\n  border-radius: 12px;\n  box-shadow: 0 8px 20px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  width: 90%;\n  max-width: 500px;\n}\n\n.currying-container h1 {\n  color: #1e3a8a;\n  margin-bottom: 1rem;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  font-size: 1rem;\n  background-color: #2563eb;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #1d4ed8;\n}\n\n#currying-result {\n  margin-top: 1rem;\n  color: #1e293b;\n  text-align: left;\n  white-space: pre-wrap;\n}',

  js: '// Currying example\nfunction runCurrying() {\n  // Standard function\n  function multiply(a, b) {\n    return a * b;\n  }\n\n  // Curried function\n  function curriedMultiply(a) {\n    return function(b) {\n      return a * b;\n    };\n  }\n\n  const double = curriedMultiply(2);\n  const triple = curriedMultiply(3);\n\n  const result = `Standard: multiply(2, 5) = ${multiply(2, 5)}\\n`\n               + `Curried: double(5) = ${double(5)}\\n`\n               + `Curried: triple(5) = ${triple(5)}`;\n\n  document.getElementById("currying-result").textContent = result;\n  console.log("Currying demo complete.");\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("Currying example is ready.");\n});'
};

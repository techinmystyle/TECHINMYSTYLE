...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Break Statement</code> in JavaScript is used to immediately exit from loops or switch statements, terminating the current iteration and transferring control to the next statement after the loop. It's commonly used for early loop termination, switch case handling, nested loop control, or optimizing performance by avoiding unnecessary iterations.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Break Statement Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="break-container">\n    <h1>Break Statement Demo</h1>\n    <button class="break-btn" onclick="runBreakExample()">Run Loop with break</button>\n    <pre id="break-result"></pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: sans-serif;\n  background-color: #fef2f2;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.break-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\n.break-container h1 {\n  margin-bottom: 1rem;\n  color: #991b1b;\n}\n\n.break-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #dc2626;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.break-btn:hover {\n  background-color: #b91c1c;\n}\n\n#break-result {\n  margin-top: 1rem;\n  color: #7f1d1d;\n  white-space: pre-wrap;\n  text-align: left;\n}',

  js: '// Demonstrating the break statement in a loop\nfunction runBreakExample() {\n  let result = "";\n  for (let i = 1; i <= 10; i++) {\n    if (i === 5) {\n      result += `Breaking loop at i = ${i}\\n`;\n      break;\n    }\n    result += `i = ${i}\\n`;\n  }\n  document.getElementById("break-result").textContent = result;\n  console.log("Break statement executed.");\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("Break demo is ready.");\n});'
};

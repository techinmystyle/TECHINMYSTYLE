...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Date Object</code> in JavaScript is a built-in object that represents dates and times, providing methods for creating, manipulating, and formatting temporal data like <code>new Date()</code>, <code>getTime()</code>, <code>toISOString()</code>, and <code>setFullYear()</code>. It's commonly used for timestamps, scheduling, date calculations, time zone handling, or any application requiring date and time functionality.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Date Object Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="date-container">\n    <h1>JavaScript Date Object</h1>\n    <button onclick="showDate()">Show Current Date & Time</button>\n    <pre id="date-result"></pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #fef9c3;\n  margin: 0;\n  padding: 0;\n  height: 100vh;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n.date-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  max-width: 90%;\n}\n\n.date-container h1 {\n  margin-bottom: 1rem;\n  color: #ca8a04;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #facc15;\n  color: #111827;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\nbutton:hover {\n  background-color: #eab308;\n}\n\n#date-result {\n  margin-top: 1rem;\n  color: #78350f;\n  text-align: left;\n  white-space: pre-wrap;\n}',

  js: 'function showDate() {\n  const now = new Date();\n  const readable = now.toString();\n  const iso = now.toISOString();\n  const year = now.getFullYear();\n  const month = now.getMonth() + 1;\n  const day = now.getDate();\n  const time = now.toLocaleTimeString();\n\n  const output = \n    `Full Date: ${readable}\\nISO Format: ${iso}\\nYear: ${year}\\nMonth: ${month}\\nDay: ${day}\\nTime: ${time}`;\n\n  document.getElementById("date-result").textContent = output;\n  console.log("Date Object information displayed.");\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("Date Object demo ready.");\n});'
};

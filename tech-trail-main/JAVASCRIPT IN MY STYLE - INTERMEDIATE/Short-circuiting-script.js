...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Short-circuiting</code> in JavaScript is a behavior of logical operators (<code>&&</code>, <code>||</code>) where evaluation stops as soon as the result is determined, with <code>&&</code> returning the first falsy value or the last value, and <code>||</code> returning the first truthy value or the last value. It's commonly used for conditional execution, default value assignment, performance optimization, null checking, or creating concise conditional logic without explicit if statements.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Short-Circuiting Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="shortcircuit-container">\n    <h1>JavaScript Short-Circuiting</h1>\n    <button id="runBtn">Run Example</button>\n    <pre id="output">Click the button to see short-circuiting in action.</pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #ecfdf5;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.shortcircuit-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  max-width: 600px;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #10b981;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n  margin-top: 1rem;\n}\n\nbutton:hover {\n  background-color: #059669;\n}\n\n#output {\n  margin-top: 1.5rem;\n  font-family: monospace;\n  text-align: left;\n  color: #065f46;\n  white-space: pre-wrap;\n}',

  js: '// Short-Circuiting Example\nconst button = document.getElementById("runBtn");\nconst output = document.getElementById("output");\n\nbutton.addEventListener("click", () => {\n  let a = null;\n  let b = \"Fallback\";\n\n  // OR short-circuits if first value is truthy\n  let orResult = a || b;\n\n  let c = true;\n  let d = \"Executed\";\n\n  // AND short-circuits if first value is falsy\n  let andResult = c && d;\n\n  let message = \"a || b: \" + orResult + \"\\n\";\n  message += \"c && d: \" + andResult + \"\\n\";\n  \n  // Falsy AND\n  c = false;\n  andResult = c && d;\n  message += \"false && d: \" + andResult;\n\n  output.textContent = message;\n});'
};

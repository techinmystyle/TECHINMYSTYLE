...
<div class="flex items-start">
  ...
  <p>
    <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">yield</code> keyword is used in JavaScript generators to pause and resume function execution. It allows creating lazy iterators, pausing the function at each <code class="bg-gray-50 px-1 rounded">yield</code> and resuming from there when <code class="bg-gray-50 px-1 rounded">next()</code> is called.</span>
  </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Generators & Yield Keyword</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="generator-container">\n    <h1>Generator Function with Yield</h1>\n    <button id="startBtn">Start Generator</button>\n    <pre id="output">Click the button to run generator.</pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #e0f2fe;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.generator-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 16px rgba(0,0,0,0.1);\n  text-align: center;\n  max-width: 600px;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #2563eb;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n  margin-top: 1rem;\n}\n\nbutton:hover {\n  background-color: #1e40af;\n}\n\n#output {\n  margin-top: 1rem;\n  font-family: monospace;\n  background-color: #dbeafe;\n  padding: 1rem;\n  border-radius: 5px;\n  color: #1e3a8a;\n  white-space: pre-wrap;\n}',

  js: '// Generator function example\nfunction* numberGenerator() {\n  yield 1;\n  yield 2;\n  yield 3;\n  return 4;\n}\n\nconst button = document.getElementById("startBtn");\nconst output = document.getElementById("output");\n\nbutton.addEventListener("click", () => {\n  const gen = numberGenerator();\n  let result = "";\n  let next = gen.next();\n\n  while (!next.done) {\n    result += `Yielded value: ${next.value}\\n`;\n    next = gen.next();\n  }\n  result += `Returned value: ${next.value}`;\n  output.textContent = result;\n});'
};

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Output Methods (console.log, alert, document.write)</code> in JavaScript are different ways to display information: <code>console.log()</code> outputs to the browser's developer console, <code>alert()</code> shows popup dialog boxes, and <code>document.write()</code> writes directly to the HTML document. They're commonly used for debugging, user notifications, testing, development logging, or displaying information during different stages of application development and user interaction.</span>
    </p>
</div>
  `;
...
<body>
  <div class="output-container">
    <h1>Output Methods Demo</h1>
    <button id="consoleBtn">Console Log</button>
    <button id="alertBtn">Alert</button>
    <button id="writeBtn">Document Write</button>
    <p id="infoText">Open the console to see the log output.</p>
  </div>
...
writeBtn.addEventListener("click", () => {
  document.write("<h2>You used document.write()</h2>");
  // Be careful: this replaces the whole document!
});`
};

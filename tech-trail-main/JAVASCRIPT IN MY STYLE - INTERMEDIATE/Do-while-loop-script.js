...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">do...while Loop</code> in JavaScript is a control structure that executes a block of code at least once before checking the condition, continuing to loop as long as the condition remains true. It's commonly used for user input validation, menu systems, game loops, data processing where at least one iteration is required, or scenarios where the loop body must execute before the condition can be evaluated.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Do...While Loop Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="loop-container">\n    <h1>Do...While Loop Demo</h1>\n    <button class="loop-btn" onclick="runDoWhileLoop()">Run Loop</button>\n    <pre id="loop-output"></pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: monospace;\n  background-color: #fefce8;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.loop-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\n.loop-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #f59e0b;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.loop-btn:hover {\n  background-color: #d97706;\n}\n\n#loop-output {\n  margin-top: 1rem;\n  color: #78350f;\n  text-align: left;\n  white-space: pre-wrap;\n}',

  js: '// Do...While Loop Example\nfunction runDoWhileLoop() {\n  let i = 1;\n  let result = "";\n\n  do {\n    result += `Count is: ${i}\\n`;\n    i++;\n  } while (i <= 5);\n\n  document.getElementById("loop-output").textContent = result;\n  console.log("Do...While loop executed.");\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("Do...While Loop demo is ready.");\n});'
};

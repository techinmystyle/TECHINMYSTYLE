...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Control Flow</code> in JavaScript refers to the order in which statements are executed, managed through conditional statements, loops, functions, and control structures like <code>if</code>, <code>for</code>, <code>while</code>, <code>switch</code>, <code>break</code>, and <code>continue</code>. It's commonly used for decision-making logic, repetitive tasks, program structure, error handling, or directing the execution path based on conditions and data.</span>
    </p>
</div>
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Control Flow Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="controlflow-container">\n    <h1>Control Flow Demo</h1>\n    <button class="controlflow-btn" onclick="runControlFlow()">Run Control Flow</button>\n    <p id="controlflow-result"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #f0f9ff;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.controlflow-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0,0,0,0.1);\n  text-align: center;\n}\n\n.controlflow-container h1 {\n  margin-bottom: 1rem;\n  color: #0369a1;\n}\n\n.controlflow-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #0284c7;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.controlflow-btn:hover {\n  background-color: #0369a1;\n}\n\n#controlflow-result {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #064e3b;\n}',

  js: '// Control Flow Example\nfunction runControlFlow() {\n  const number = 7;\n  let result = "";\n\n  if (number > 0) {\n    result = "The number " + number + " is positive.";\n  } else if (number < 0) {\n    result = "The number " + number + " is negative.";\n  } else {\n    result = "The number is zero.";\n  }\n\n  document.getElementById("controlflow-result").textContent = result;\n  console.log("Control flow example executed:", result);\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("Control flow demo is ready.");\n});'
};

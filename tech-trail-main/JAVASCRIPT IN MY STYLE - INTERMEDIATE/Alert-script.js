...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">alert()</code> method in JavaScript displays a modal dialog box with a message and an OK button. It's commonly used for debugging, showing simple notifications, displaying error messages, or providing basic user alerts in web applications.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>alert() Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="alert-container">\n    <h1>alert() Demo</h1>\n    <button class="alert-btn" onclick="showAlert()">Show Alert</button>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #fef2f2;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.alert-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\n.alert-container h1 {\n  margin-bottom: 1rem;\n  color: #991b1b;\n}\n\n.alert-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #dc2626;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.alert-btn:hover {\n  background-color: #b91c1c;\n}',

  js: '// JavaScript using alert()\nfunction showAlert() {\n  alert("This is an alert message!");\n  console.log("Alert was shown to the user.");\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("alert() demo is ready.");\n});'
};

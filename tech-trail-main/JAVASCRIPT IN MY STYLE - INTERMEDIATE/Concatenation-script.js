...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Concatenation</code> in JavaScript is the process of joining two or more strings together using the plus operator (<code>+</code>), template literals, or methods like <code>concat()</code>. It's commonly used for building dynamic messages, creating URLs, formatting output, combining user input, or constructing strings from multiple variables and literal values.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Concatenation Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="concat-container">\n    <h1>Concatenation Demo</h1>\n    <button class="concat-btn" onclick="runConcatenation()">Concatenate</button>\n    <p id="concat-result"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: sans-serif;\n  background-color: #fef2f2;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.concat-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\n.concat-container h1 {\n  margin-bottom: 1rem;\n  color: #b91c1c;\n}\n\n.concat-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #dc2626;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.concat-btn:hover {\n  background-color: #991b1b;\n}\n\n#concat-result {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #7f1d1d;\n}',

  js: '// Concatenation Example\nfunction runConcatenation() {\n  const firstName = "John";\n  const lastName = "Doe";\n\n  const fullName = firstName + " " + lastName;\n  document.getElementById("concat-result").textContent = "Full Name: " + fullName;\n  console.log("Concatenation result:", fullName);\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("Concatenation demo ready.");\n});'
};

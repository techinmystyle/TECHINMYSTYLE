...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">slice()</code> method in JavaScript is a non-mutating array and string method that returns a shallow copy of a portion of the original data structure, specified by start and end indices, without modifying the original array or string. It's commonly used for extracting subarrays, creating array copies, implementing pagination, text processing, data filtering, or creating immutable operations where you need portions of data without altering the original source.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>slice() Method Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="slice-container">\n    <h1>JavaScript slice()</h1>\n    <button id="runBtn">Run Example</button>\n    <pre id="output">Click the button to slice arrays and strings.</pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #f0fdf4;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.slice-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  max-width: 600px;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #22c55e;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n  margin-top: 1rem;\n}\n\nbutton:hover {\n  background-color: #16a34a;\n}\n\n#output {\n  margin-top: 1.5rem;\n  font-family: monospace;\n  text-align: left;\n  color: #15803d;\n  white-space: pre-wrap;\n}',

  js: '// slice() Method Example\nconst button = document.getElementById("runBtn");\nconst output = document.getElementById("output");\n\nbutton.addEventListener("click", () => {\n  const fruits = [\"apple\", \"banana\", \"cherry\", \"date\", \"elderberry\"];\n  const slicedFruits = fruits.slice(1, 4); // from index 1 to 3\n\n  const text = \"JavaScript Slice Method\";\n  const slicedText = text.slice(0, 10); // first 10 characters\n\n  let message = \"Original array: \" + JSON.stringify(fruits) + \"\\n\";\n  message += \"Sliced array (1 to 4): \" + JSON.stringify(slicedFruits) + \"\\n\\n\";\n  message += \"Original string: \\\"\" + text + \"\\\"\\n\";\n  message += \"Sliced string (0 to 10): \\\"\" + slicedText + \"\\\"\";\n\n  output.textContent = message;\n});'
};

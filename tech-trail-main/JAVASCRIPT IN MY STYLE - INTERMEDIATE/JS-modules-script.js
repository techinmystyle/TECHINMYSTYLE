...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">JS Modules</code> are a way to organize JavaScript code into separate files with their own scope, using ES6 import/export syntax or CommonJS require/module.exports to share functionality between files while maintaining encapsulation. They're commonly used for code organization, dependency management, creating reusable components, building scalable applications, or maintaining clean separation of concerns across different parts of large JavaScript projects.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  ...
  js: '// --- main.js ---\nimport { greet } from "./utils.js";\n\nconst button = document.getElementById("greetBtn");\nconst result = document.getElementById("result");\n\nbutton.addEventListener("click", () => {\n  result.textContent = greet("Visitor");\n});\n\n// --- utils.js ---\nexport function greet(name) {\n  return `Hello, ${name}! Welcome to JS Modules.`;\n}'
};

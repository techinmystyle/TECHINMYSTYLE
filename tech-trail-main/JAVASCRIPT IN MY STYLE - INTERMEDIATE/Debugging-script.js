...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Debugging</code> in JavaScript is the process of identifying, analyzing, and fixing errors or bugs in code using tools like browser developer tools, console methods, breakpoints, and debugger statements. It's commonly used for error identification, code inspection, performance analysis, logic verification, or ensuring applications function correctly across different scenarios and environments.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  ...
  js: 'function debugExample() {\n  let a = 5;\n  let b = 0;\n  console.log("Initial values - a:", a, "b:", b);\n\n  // Intentional mistake for debugging\n  // You can use debugger; to pause and inspect values\n  try {\n    let result = a / b;\n    console.log("Result calculated");\n    if (!isFinite(result)) throw new Error("Division by zero!");\n    document.getElementById("debug-result").textContent = `Result: ${result}`;\n  } catch (error) {\n    console.error("An error occurred:", error);\n    document.getElementById("debug-result").textContent = `Error: ${error.message}`;\n  }\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("Debugging demo is ready.");\n});'
};

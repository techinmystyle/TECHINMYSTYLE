...
<div class="flex items-start">
    ...
    <p>
        <span><code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Variables</code> in JavaScript are containers used to store data values. They can be declared using <code class="bg-gray-50 px-1 rounded">var</code>, <code class="bg-gray-50 px-1 rounded">let</code>, or <code class="bg-gray-50 px-1 rounded">const</code>, each offering different scoping and mutability rules. Proper use of variables is fundamental to writing clean and efficient code.</span>
    </p>
</div>
  `;

...
document.addEventListener("DOMContentLoaded", () => {
  ...
  infoBanner.innerHTML = `
    <div class="flex items-start">
        ...
        <p>
            <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Encapsulation</code> is an Object-Oriented Programming concept that binds together the data and functions that manipulate the data, and that keeps both safe from outside interference and misuse. It involves restricting direct access to some of an object's components, which is a means of preventing accidental interference and misuse of the methods and data.</span>
        </p>
    </div>
  `;
...
function initializeEditor() {
  ...
  const defaultCode = {
    html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Encapsulation Demo</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="encapsulation-container">\n    <h1>Encapsulation Demo</h1>\n    <div class="input-group">\n      <label for="name-input">Enter Name:</label>\n      <input type="text" id="name-input" placeholder="Enter name">\n    </div>\n    <div class="input-group">\n      <label for="age-input">Enter Age:</label>\n      <input type="number" id="age-input" placeholder="Enter age">\n    </div>\n    <div class="button-group">\n      <button class="encapsulation-btn" onclick="createPerson()">Create Person</button>\n      <button class="encapsulation-btn" onclick="displayPerson()">Display Person</button>\n    </div>\n    <pre id="encapsulation-output"></pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

    css: 'body {\n  font-family: monospace;\n  background-color: #eef2ff;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.encapsulation-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  max-width: 90%;\n}\n\n.input-group {\n  margin: 1rem 0;\n}\n\n.input-group label {\n  display: block;\n  margin-bottom: 0.5rem;\n}\n\n.input-group input {\n  width: 100%;\n  padding: 0.5rem;\n  border: 1px solid #ccc;\n  border-radius: 4px;\n}\n\n.button-group {\n  display: flex;\n  justify-content: center;\n  gap: 1rem;\n  margin: 1rem 0;\n}\n\n.encapsulation-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #6366f1;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.encapsulation-btn:hover {\n  background-color: #4f46e5;\n}\n\n#encapsulation-output {\n  margin-top: 1rem;\n  color: #1e3a8a;\n  text-align: left;\n  white-space: pre-wrap;\n}',

    js: '// Encapsulation Example\nclass Person {\n  constructor(name, age) {\n    this._name = name;\n    this._age = age;\n  }\n\n  // Getter for name\n  get name() {\n    return this._name;\n  }\n\n  // Setter for name\n  set name(newName) {\n    this._name = newName;\n  }\n\n  // Getter for age\n  get age() {\n    return this._age;\n  }\n\n  // Setter for age\n  set age(newAge) {\n    if (newAge > 0) {\n      this._age = newAge;\n    } else {\n      console.log("Age must be a positive number.");\n    }\n  }\n\n  // Method to display person info\n  displayInfo() {\n    return `Name: ${this._name}, Age: ${this._age}`;\n  }\n}\n\n// Global variable to hold the person instance\nlet person;\n\nfunction createPerson() {\n  const name = document.getElementById("name-input").value;\n  const age = parseInt(document.getElementById("age-input").value);\n  person = new Person(name, age);\n  document.getElementById("encapsulation-output").textContent = "Person created successfully.";\n  console.log("Person created.");\n}\n\nfunction displayPerson() {\n  if (person) {\n    document.getElementById("encapsulation-output").textContent = person.displayInfo();\n    console.log("Person info displayed.");\n  } else {\n    document.getElementById("encapsulation-output").textContent = "No person created yet.";\n    console.log("No person created yet.");\n  }\n}\n\n// Event listener for DOM content loaded\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("Encapsulation demo is ready.");\n});'
  };

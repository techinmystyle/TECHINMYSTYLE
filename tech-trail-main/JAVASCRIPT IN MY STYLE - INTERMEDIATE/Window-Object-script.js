...
<div class="flex items-start">
  ...
  <p>
    <span><code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Window Object</code> is the global object in browsers representing the browser window. It provides access to methods like <code class="bg-gray-50 px-1 rounded">alert()</code>, <code class="bg-gray-50 px-1 rounded">setTimeout()</code>, and properties like <code class="bg-gray-50 px-1 rounded">document</code>, <code class="bg-gray-50 px-1 rounded">location</code>, and <code class="bg-gray-50 px-1 rounded">innerWidth</code>.</span>
  </p>
</div>

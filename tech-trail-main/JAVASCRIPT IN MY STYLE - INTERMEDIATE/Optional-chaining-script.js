...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Optional Chaining</code> in JavaScript is an ES2020 feature that uses the <code>?.</code> operator to safely access deeply nested object properties without throwing errors if any reference in the chain is null or undefined, returning undefined instead. It's commonly used for API data handling, nested object access, preventing runtime errors, working with uncertain data structures, or safely accessing properties when the existence of intermediate objects cannot be guaranteed.</span>
    </p>
</div>
  `;
...
<body>
  <div class="optional-container">
    ...
    <button id="checkBtn">Check Profile</button>
    <p id="result"></p>
  </div>
...
button.addEventListener("click", () => {
  ...
  const phone = user.contact?.phone ?? "Phone number not available.";
  result.textContent = phone;
  console.log("Checked phone:", phone);
});`
};

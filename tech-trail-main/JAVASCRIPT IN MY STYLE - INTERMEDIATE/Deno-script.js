...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Deno</code> is a modern JavaScript and TypeScript runtime built on V8 that provides secure defaults, built-in TypeScript support, and a standard library without requiring external package managers. It's commonly used for server-side development, command-line tools, web APIs, microservices, or building secure applications with explicit permission controls for file system, network, and environment access.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Deno Simulation</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="deno-container">\n    <h1>Deno vs Node.js</h1>\n    <button class="deno-btn" onclick="simulateDeno()">Simulate Deno</button>\n    <pre id="deno-output"></pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: monospace;\n  background-color: #eef2ff;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.deno-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  max-width: 90%;\n}\n\n.deno-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #6366f1;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.deno-btn:hover {\n  background-color: #4f46e5;\n}\n\n#deno-output {\n  margin-top: 1rem;\n  color: #1e3a8a;\n  text-align: left;\n  white-space: pre-wrap;\n}',

  js: '// Deno vs Node.js Simulation\nfunction simulateDeno() {\n  const denoExample = `// Deno Example (actual environment)\nconst text = await Deno.readTextFile("example.txt");\nconsole.log(text);`;\n\n  const explanation = `Deno is a modern runtime for JavaScript and TypeScript:\n- Built with Rust\n- Uses ES Modules\n- Has secure defaults\n- Includes a built-in package manager (no node_modules)`;\n\n  const simulatedResult = `// Simulated Deno Code:\\n${denoExample}\\n\\n// About Deno:\\n${explanation}`;\n\n  document.getElementById("deno-output").textContent = simulatedResult;\n  console.log("Deno simulation shown.");\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("Deno demo is ready.");\n});'
};

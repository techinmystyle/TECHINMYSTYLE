...
<div class="flex items-start">
  ...
  <p>
    <span><code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Web Workers</code> allow you to run JavaScript in background threads, separate from the main execution thread, enabling long tasks like computations or data processing without freezing the user interface.</span>
  </p>
</div>

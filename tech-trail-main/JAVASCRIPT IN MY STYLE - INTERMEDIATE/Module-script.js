...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Modules (ES6)</code> in JavaScript are the standardized module system introduced in ECMAScript 2015, using <code>import</code> and <code>export</code> statements to share code between files with static analysis, tree-shaking support, and strict mode by default. They're commonly used for modern JavaScript development, code splitting, dependency management, building scalable applications, or creating maintainable codebases with clear module boundaries and optimized bundling capabilities.</span>
    </p>
</div>
  `;
...
<body>
  <div class="container">
    <h1>ES6 Modules</h1>
    <p>This demo showcases how to use <strong>import</strong> and <strong>export</strong> in JavaScript ES6 Modules.</p>
    
    <button id="loadModuleBtn">Load Module</button>
...
.output-box {
  ...
  js: `// File: main.js (entry point - loaded with type="module")

import { greetUser, userName } from './module.js';
...
loadModuleBtn.addEventListener('click', () => {
  ...
  moduleJs: `// File: module.js (exported module)

export const userName = 'BASHA RAM';

export function greetUser(name) {
  return \`Welcome, \${name}! This is an ES6 Module Demo.\`;
}`
};

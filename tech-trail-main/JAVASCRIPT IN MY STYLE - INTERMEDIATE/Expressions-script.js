...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Expressions</code> in JavaScript are combinations of values, variables, operators, and function calls that evaluate to a single value, including arithmetic expressions, logical expressions, function expressions, and conditional expressions. They're commonly used for calculations, value assignments, conditional logic, function definitions, property access, or any operation that produces a result value in JavaScript code.</span>
    </p>
</div>
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>JavaScript Expressions</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="expression-container">\n    <h1>JavaScript Expressions Demo</h1>\n    <button id="evaluateBtn">Evaluate Expression</button>\n    <p id="result"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #fdf4ff;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.expression-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 20px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #d946ef;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  font-size: 1rem;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #a21caf;\n}\n\n#result {\n  margin-top: 1rem;\n  color: #6b21a8;\n  font-weight: bold;\n}',

  js: '// JavaScript Expressions Example\ndocument.addEventListener("DOMContentLoaded", () => {\n  const button = document.getElementById("evaluateBtn");\n  const result = document.getElementById("result");\n\n  button.addEventListener("click", () => {\n    let a = 7;\n    let b = 3;\n    let sum = a + b; // Arithmetic expression\n    let message = `${a} + ${b} = ${sum}`; // Template string expression\n\n    result.textContent = message;\n    console.log("Expression evaluated:", message);\n  });\n});'
};

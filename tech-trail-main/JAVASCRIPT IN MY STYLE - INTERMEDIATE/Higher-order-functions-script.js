...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Higher-Order Functions</code> in JavaScript are functions that either take other functions as arguments, return functions as results, or both, enabling powerful functional programming patterns like <code>map()</code>, <code>filter()</code>, <code>reduce()</code>, and custom function factories. They're commonly used for data transformation, functional composition, callback handling, creating reusable utilities, or implementing abstract operations that can work with different behaviors passed as function parameters.</span>
    </p>
</div>
  `;

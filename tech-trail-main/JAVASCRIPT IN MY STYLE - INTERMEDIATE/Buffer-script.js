...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Buffer</code> in JavaScript (Node.js) is a global object that provides a way to handle binary data directly, representing a fixed-size sequence of bytes. It's commonly used for file operations, network communication, cryptographic functions, image processing, or any scenario requiring manipulation of raw binary data outside the browser environment.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Buffer Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="buffer-container">\n    <h1>Buffer Demo</h1>\n    <button class="buffer-btn" onclick="simulateBuffer()">Simulate Buffer</button>\n    <pre id="buffer-result"></pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: monospace;\n  background-color: #f0fdf4;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.buffer-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\n.buffer-container h1 {\n  margin-bottom: 1rem;\n  color: #166534;\n}\n\n.buffer-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #22c55e;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.buffer-btn:hover {\n  background-color: #16a34a;\n}\n\n#buffer-result {\n  margin-top: 1rem;\n  color: #14532d;\n  white-space: pre-wrap;\n  text-align: left;\n}',

  js: '// Simulate Buffer usage using Uint8Array in the browser\nfunction simulateBuffer() {\n  const text = "Hello";\n  const encoder = new TextEncoder();\n  const buffer = encoder.encode(text); // Returns Uint8Array\n\n  let result = `Original Text: ${text}\\n`;\n  result += `Encoded Buffer (Uint8Array): [${buffer.join(", ")}]\\n`;\n\n  const decoder = new TextDecoder();\n  const decodedText = decoder.decode(buffer);\n  result += `Decoded Back to Text: ${decodedText}`;\n\n  document.getElementById("buffer-result").textContent = result;\n  console.log("Buffer simulation complete.");\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("Buffer demo is ready.");\n});'
};

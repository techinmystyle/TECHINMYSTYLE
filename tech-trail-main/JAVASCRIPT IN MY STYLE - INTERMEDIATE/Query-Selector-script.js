...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">querySelector()</code> method in JavaScript is a DOM API that returns the first element that matches a specified CSS selector string, providing a powerful and flexible way to select elements using CSS syntax like classes, IDs, attributes, and pseudo-selectors. It's commonly used for DOM manipulation, event handling, element selection, dynamic content updates, or accessing specific HTML elements for styling, modification, or interaction in web applications.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>querySelector Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="query-container">\n    <h1 class="title">querySelector Demo</h1>\n    <button id="changeBtn">Change Title Color</button>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #f0f4ff;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.query-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\nh1 {\n  color: #1d4ed8;\n  margin-bottom: 1rem;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #3b82f6;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #2563eb;\n}',

  js: '// querySelector Example\nconst title = document.querySelector(".title");\nconst button = document.querySelector("#changeBtn");\n\nbutton.addEventListener("click", () => {\n  title.style.color = "#dc2626"; // Change to red\n  console.log("Title color changed using querySelector()");\n});'
};

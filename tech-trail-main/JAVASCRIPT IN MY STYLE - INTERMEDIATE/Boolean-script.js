...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Boolean</code> in JavaScript is a primitive data type that represents logical values of either <code>true</code> or <code>false</code>. It's commonly used for conditional statements, logical operations, flag variables, form validation, or any scenario requiring binary decision-making and control flow in applications.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Boolean Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="boolean-container">\n    <h1>Boolean Demo</h1>\n    <button class="boolean-btn" onclick="checkBoolean()">Check Boolean</button>\n    <p id="boolean-result"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: sans-serif;\n  background-color: #ecfccb;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.boolean-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\n.boolean-container h1 {\n  margin-bottom: 1rem;\n  color: #365314;\n}\n\n.boolean-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #84cc16;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.boolean-btn:hover {\n  background-color: #65a30d;\n}\n\n#boolean-result {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #3f6212;\n}',

  js: '// Demonstrate Boolean type in JavaScript\nfunction checkBoolean() {\n  const value1 = Boolean(0); // false\n  const value2 = Boolean(1); // true\n  const value3 = Boolean(\"Hello\"); // true\n  const value4 = Boolean(\"\"); // false\n\n  const result = `Boolean(0): ${value1}\\nBoolean(1): ${value2}\\nBoolean("Hello"): ${value3}\\nBoolean(""): ${value4}`;\n\n  document.getElementById("boolean-result").textContent = result;\n  console.log("Boolean values checked.");\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("Boolean demo is ready.");\n});'
};

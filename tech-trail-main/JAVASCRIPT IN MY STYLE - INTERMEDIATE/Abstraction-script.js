...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Abstraction</code> concept in JavaScript hides complex implementation details while exposing only essential features. It's commonly used to simplify interfaces, create reusable modules, reduce code complexity, or provide clean APIs that hide underlying functionality.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Abstraction Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="abstraction-container">\n    <h1>Abstraction Demo</h1>\n    <button class="abstract-btn" onclick="showVehicleDetails()">Show Vehicle</button>\n    <p id="output"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #e0f2fe;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.abstraction-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\n.abstraction-container h1 {\n  margin-bottom: 1rem;\n  color: #1e40af;\n}\n\n.abstract-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #3b82f6;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.abstract-btn:hover {\n  background-color: #2563eb;\n}\n\n#output {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #1d4ed8;\n}',

  js: '// JavaScript demonstrating Abstraction using a class\nclass Vehicle {\n  constructor(brand, model) {\n    this.brand = brand;\n    this.model = model;\n  }\n\n  // Abstracted method to get vehicle details\n  getDetails() {\n    return `Brand: ${this.brand}, Model: ${this.model}`;\n  }\n}\n\nfunction showVehicleDetails() {\n  const car = new Vehicle("Toyota", "Corolla");\n  const output = document.getElementById("output");\n  output.textContent = car.getDetails();\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("Abstraction demo is ready.");\n});'
};

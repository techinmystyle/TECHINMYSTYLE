...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">parseInt()</code> function in JavaScript parses a string and returns an integer, optionally accepting a radix parameter to specify the base (2-36) for number conversion, and stops parsing when it encounters the first non-numeric character. It's commonly used for converting user input, parsing numeric strings, handling form data, extracting numbers from mixed content, or converting strings to integers for mathematical operations and data processing.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>parseInt() Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="parseint-container">\n    <h1>parseInt() Demo</h1>\n    <input type="text" id="numberInput" placeholder="Enter a value" />\n    <button id="parseBtn">Parse Integer</button>\n    <p id="output">Result will appear here.</p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #f0f9ff;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.parseint-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  width: 300px;\n}\n\ninput {\n  padding: 0.5rem;\n  font-size: 1rem;\n  margin-bottom: 1rem;\n  width: 80%;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #2563eb;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #1d4ed8;\n}\n\n#output {\n  margin-top: 1rem;\n  color: #1e3a8a;\n  font-weight: bold;\n}',

  js: '// parseInt() Example\nconst parseBtn = document.getElementById("parseBtn");\nconst numberInput = document.getElementById("numberInput");\nconst output = document.getElementById("output");\n\nparseBtn.addEventListener("click", () => {\n  const userInput = numberInput.value;\n  const parsed = parseInt(userInput);\n\n  if (isNaN(parsed)) {\n    output.textContent = "Invalid input. Cannot parse to integer.";\n  } else {\n    output.textContent = `Parsed integer: ${parsed}`;\n  }\n});'
};

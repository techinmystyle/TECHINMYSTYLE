...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Loops (for, while, do-while)</code> in JavaScript are control structures that repeatedly execute code blocks: <code>for</code> loops with initialization, condition, and increment; <code>while</code> loops that continue while a condition is true; and <code>do-while</code> loops that execute at least once before checking the condition. They're commonly used for array iteration, repetitive tasks, data processing, counting operations, or any scenario requiring repeated execution of code blocks.</span>
    </p>
</div>
  `;

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Switch Statement</code> in JavaScript is a control flow statement that evaluates an expression and executes code blocks based on matching case values, using <code>break</code> statements to prevent fall-through and an optional <code>default</code> case for unmatched values. It's commonly used for handling multiple conditional branches, menu systems, state management, value mapping, or replacing long chains of if-else statements when comparing a single variable against multiple possible values.</span>
    </p>
</div>
  `;

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Backticks</code> in JavaScript are used to create template literals, allowing for string interpolation with <code>${'{}'}</code> syntax, multi-line strings, and embedded expressions. They're commonly used for dynamic string creation, HTML templating, SQL queries, or any scenario requiring variable substitution within strings.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Backticks Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="backticks-container">\n    <h1>Backticks Demo</h1>\n    <button class="backticks-btn" onclick="useBackticks()">Run Example</button>\n    <p id="backticks-result"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #e0f2fe;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.backticks-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\n.backticks-container h1 {\n  margin-bottom: 1rem;\n  color: #0c4a6e;\n}\n\n.backticks-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #0284c7;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.backticks-btn:hover {\n  background-color: #0369a1;\n}\n\n#backticks-result {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #075985;\n}',

  js: '// JavaScript example using backticks (template literals)\nfunction useBackticks() {\n  const name = "JavaScript";\n  const version = 6;\n  const message = `Welcome to ${name} ES${version}!`;\n  document.getElementById("backticks-result").textContent = message;\n  console.log("Backticks used:", message);\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("Backticks demo ready.");\n});'
};

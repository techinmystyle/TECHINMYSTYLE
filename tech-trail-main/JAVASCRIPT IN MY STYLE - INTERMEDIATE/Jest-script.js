...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Jest (Testing Framework)</code> is a comprehensive JavaScript testing framework developed by Facebook that provides features like test runners, assertion libraries, mocking capabilities, code coverage reports, and snapshot testing out of the box. It's commonly used for unit testing, integration testing, test-driven development, continuous integration, or ensuring code quality and reliability in JavaScript applications with minimal configuration required.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Jest Test Simulation</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="jest-container">\n    <h1>Jest Test Simulation</h1>\n    <button id="runTests">Run Tests</button>\n    <div id="result"></div>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #f1f5f9;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.jest-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  width: 400px;\n}\n\nbutton {\n  padding: 0.5rem 1rem;\n  background-color: #ef4444;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #dc2626;\n}\n\n#result {\n  margin-top: 1rem;\n  text-align: left;\n  font-family: monospace;\n  color: #1e293b;\n}',

  js: '// Simulating Jest-style testing in browser\nfunction add(a, b) {\n  return a + b;\n}\n\nfunction runTest(description, fn) {\n  const resultDiv = document.getElementById("result");\n  try {\n    fn();\n    resultDiv.innerHTML += `✅ ${description}<br>`;\n  } catch (error) {\n    resultDiv.innerHTML += `❌ ${description}<br>   ↳ ${error.message}<br>`;\n  }\n}\n\nfunction expect(received) {\n  return {\n    toBe(expected) {\n      if (received !== expected) {\n        throw new Error(`Expected ${expected} but received ${received}`);\n      }\n    }\n  };\n}\n\ndocument.getElementById("runTests").addEventListener("click", () => {\n  document.getElementById("result").innerHTML = \"\";\n\n  runTest(\"adds 1 + 2 to equal 3\", () => {\n    expect(add(1, 2)).toBe(3);\n  });\n\n  runTest(\"adds 5 + 7 to equal 12\", () => {\n    expect(add(5, 7)).toBe(12);\n  });\n\n  runTest(\"adds 10 + (-2) to equal 8\", () => {\n    expect(add(10, -2)).toBe(8);\n  });\n});'
};

...
<div class="flex items-start">
    ...
    <p>
        <span><code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Value vs Reference</code> in JavaScript distinguishes how data is stored and copied. Primitive types (like <code class="bg-gray-50 px-1 rounded">number</code>, <code class="bg-gray-50 px-1 rounded">string</code>, <code class="bg-gray-50 px-1 rounded">boolean</code>) are assigned by <strong>value</strong>, meaning a copy is created. Objects (like arrays and functions) are assigned by <strong>reference</strong>, meaning changes to one affect the other. Understanding this concept is key to avoiding unintended side effects in your code.</span>
    </p>
</div>
  `;

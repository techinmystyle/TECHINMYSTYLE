...
<div class="flex items-start">
  ...
  <p>
    <span><code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Zero-Based Indexing</code> means arrays and strings in JavaScript start at index <code class="bg-gray-50 px-1 rounded">0</code>. For example, <code class="bg-gray-50 px-1 rounded">arr[0]</code> returns the first element. It’s a standard practice in most programming languages for consistent access and calculation.</span>
  </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Zero-Based Indexing</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="indexing-container">\n    <h1>Zero-Based Indexing Demo</h1>\n    <button id="showBtn">Show Array Index</button>\n    <pre id="output">Click the button to see zero-based indexing in action.</pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #fef3c7;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.indexing-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  max-width: 600px;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #ca8a04;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n  margin-top: 1rem;\n}\n\nbutton:hover {\n  background-color: #854d0e;\n}\n\n#output {\n  margin-top: 1rem;\n  font-family: monospace;\n  background-color: #fef3c7;\n  padding: 1rem;\n  border-radius: 5px;\n  color: #92400e;\n  white-space: pre-wrap;\n}',

  js: '// Zero-Based Indexing Example\nconst button = document.getElementById("showBtn");\nconst output = document.getElementById("output");\n\nconst fruits = ["Apple", "Banana", "Cherry", "Date"];\n\nbutton.addEventListener("click", () => {\n  let result = "";\n  for (let i = 0; i < fruits.length; i++) {\n    result += `Index ${i}: ${fruits[i]}\\n`;\n  }\n  output.textContent = result;\n});'
};

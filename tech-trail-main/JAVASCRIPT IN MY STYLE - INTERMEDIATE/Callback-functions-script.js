...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Callback Functions</code> in JavaScript are functions passed as arguments to other functions and executed at a later time or after a specific event occurs. They're commonly used for asynchronous operations, event handling, array methods, higher-order functions, or any scenario requiring delayed or conditional function execution.</span>
    </p>
</div>
  `;

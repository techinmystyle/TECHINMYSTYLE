...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Prototype Chain</code> in JavaScript is the mechanism by which objects inherit properties and methods by following a chain of prototype references, where JavaScript looks up the chain from an object to its prototype, then to the prototype's prototype, until reaching <code>Object.prototype</code> or null. It's commonly used for inheritance hierarchies, method resolution, understanding object behavior, debugging inheritance issues, or implementing complex object-oriented patterns where objects inherit from multiple levels of prototypes.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Prototype Chain Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="chain-container">\n    <h1>Prototype Chain Demo</h1>\n    <button id="checkBtn">Check Prototype Chain</button>\n    <p id="result">Click the button to see inheritance.</p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #f3f4f6;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.chain-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  width: 320px;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #3b82f6;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  font-size: 1rem;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #2563eb;\n}\n\n#result {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #1e40af;\n}',

  js: '// Prototype Chain Example\nfunction Animal(name) {\n  this.name = name;\n}\n\nAnimal.prototype.speak = function () {\n  return `${this.name} makes a sound.`;\n};\n\nfunction Dog(name) {\n  Animal.call(this, name);\n}\n\nDog.prototype = Object.create(Animal.prototype);\nDog.prototype.constructor = Dog;\n\nDog.prototype.bark = function () {\n  return `${this.name} barks.`;\n};\n\nconst result = document.getElementById("result");\nconst btn = document.getElementById("checkBtn");\n\nbtn.addEventListener("click", () => {\n  const dog = new Dog("Rex");\n  const chain = `${dog.bark()}\\n${dog.speak()}`;\n  result.textContent = chain;\n});'
};

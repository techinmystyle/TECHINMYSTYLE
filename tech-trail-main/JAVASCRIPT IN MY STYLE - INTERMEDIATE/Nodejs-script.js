...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Node.js (Intro)</code> is a JavaScript runtime environment built on Chrome's V8 engine that enables server-side JavaScript execution, providing access to file systems, networking, and system resources through built-in modules and npm packages. It's commonly used for building web servers, REST APIs, real-time applications, command-line tools, or full-stack JavaScript development where the same language can be used for both frontend and backend development.</span>
    </p>
</div>
  `;
...
<head>
  ...
  <title>Node.js Intro Demo</title>
  <link rel="stylesheet" href="style.css" />
</head>
<body>
  <div class="container">
    <h1>Node.js Introduction</h1>
    <p>This demo explains what Node.js is and how to run a simple server using Node.js.</p>
    
    <pre id="infoBox" class="output-box">
Node.js is a runtime environment that allows you to run JavaScript outside the browser, typically on servers.
It uses the V8 engine and enables building fast, scalable network applications.

Below is a simple example of a basic HTTP server using Node.js:
...
.output-box {
  ...
  js: `// This demo is informational only, Node.js runs outside the browser.
// To try this code, save as server.js and run using command: node server.js

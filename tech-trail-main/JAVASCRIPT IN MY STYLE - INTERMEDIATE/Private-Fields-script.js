...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Private Fields</code> in JavaScript are class fields prefixed with <code>#</code> that are only accessible within the class where they're defined, providing true encapsulation and preventing external access to internal implementation details. They're commonly used for data hiding, encapsulation, protecting sensitive information, creating secure class implementations, or building robust object-oriented designs where internal state should not be accessible or modifiable from outside the class.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Private Fields in JS</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="private-container">\n    <h1>Private Fields Demo</h1>\n    <button id="showBtn">Show Account Info</button>\n    <pre id="output"></pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #e0f2fe;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.private-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #0ea5e9;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n  margin-top: 1rem;\n}\n\nbutton:hover {\n  background-color: #0284c7;\n}\n\npre {\n  margin-top: 1rem;\n  background-color: #e0f2fe;\n  color: #0369a1;\n  padding: 1rem;\n  border-radius: 8px;\n  text-align: left;\n}',

  js: '// Private Fields Example\nclass BankAccount {\n  #balance; // private field\n\n  constructor(owner, initialBalance) {\n    this.owner = owner;\n    this.#balance = initialBalance;\n  }\n\n  getBalance() {\n    return `Current balance: $${this.#balance}`;\n  }\n\n  deposit(amount) {\n    this.#balance += amount;\n  }\n}\n\nconst account = new BankAccount("Alice", 1000);\naccount.deposit(500);\n\nconst button = document.getElementById("showBtn");\nconst output = document.getElementById("output");\n\nbutton.addEventListener("click", () => {\n  output.textContent = `Owner: ${account.owner}\\n${account.getBalance()}`;\n  console.log("Displayed private field using getter.");\n});'
};

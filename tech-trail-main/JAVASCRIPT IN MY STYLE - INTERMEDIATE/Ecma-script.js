...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">ECMAScript (ES5, ES6+)</code> is the standardized specification that defines JavaScript language features, with ES5 (2009) providing stable foundations and ES6+ (2015+) introducing modern features like arrow functions, classes, modules, destructuring, and async/await. It's commonly used for understanding language evolution, browser compatibility, feature adoption, transpilation decisions, or leveraging modern JavaScript capabilities in development.</span>
    </P>
</div>
  `;
...
<head>
  ...
  <title>ECMAScript ES5 vs ES6+</title>
  <link rel="stylesheet" href="style.css" />
</head>
<body>
  <div class="container">
    <h1>ECMAScript: ES5 vs ES6+</h1>
    <p>This demo shows some key differences between ES5 and ES6+ syntax.</p>
...
`,
  ...
  js: `const runDemoBtn = document.getElementById('runDemoBtn');
...
runDemoBtn.addEventListener('click', () => {
  ...
  // ES5 Function & Variable
  log('ES5: var, function keyword');
  var es5Var = 'I am ES5 var';
  function es5Function() {
    return 'Hello from ES5 function';
  }
  log('es5Var = ' + es5Var);
  log('es5Function() = ' + es5Function());

  // ES6+ Let, Const, Arrow Function
  log('\\nES6+: let, const, arrow functions');
  let es6Let = 'I am ES6 let';
  const es6Const = 'I am ES6 const';
  const es6ArrowFunc = () => 'Hello from ES6 arrow function';

  log('es6Let = ' + es6Let);
  log('es6Const = ' + es6Const);
  log('es6ArrowFunc() = ' + es6ArrowFunc());
  ...
  function greet(msg = 'Hi') {
    return msg + ', default parameter works!';
  }
  log(greet());
  log(greet('Hello'));
  ...
  // Destructuring
  log('\\nDestructuring:');
  const person = { firstName: 'Basha', age: 25 };
  const { firstName, age } = person;
  log(\`Name: \${firstName}, Age: \${age}\`);

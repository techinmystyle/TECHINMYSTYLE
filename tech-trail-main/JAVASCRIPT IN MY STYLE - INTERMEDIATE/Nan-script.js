...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">NaN</code> (Not a Number) in JavaScript is a special numeric value that represents an undefined or unrepresentable mathematical result, returned from operations like dividing zero by zero or parsing invalid strings, and uniquely has the property that <code>NaN !== NaN</code>. It's commonly used for error handling, input validation, mathematical operations, type checking, or detecting invalid numeric computations using functions like <code>isNaN()</code> or <code>Number.isNaN()</code>.</span>
    </p>
</div>
  `;

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">AbortController()</code> constructor in JavaScript creates a controller object that allows you to abort one or more web requests. It's commonly used to cancel fetch requests, timeout operations, clean up async operations, or provide user cancellation functionality.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>AbortController Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="abort-container">\n    <h1>AbortController Demo</h1>\n    <button class="start-btn" onclick="fetchData()">Start Fetch</button>\n    <button class="abort-btn" onclick="abortFetch()">Abort Fetch</button>\n    <p id="status"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #ecfdf5;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.abort-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\n.abort-container h1 {\n  margin-bottom: 1rem;\n  color: #065f46;\n}\n\n.start-btn, .abort-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #10b981;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  margin: 0.3rem;\n  transition: background-color 0.3s ease;\n}\n\n.abort-btn {\n  background-color: #ef4444;\n}\n\n.start-btn:hover {\n  background-color: #059669;\n}\n\n.abort-btn:hover {\n  background-color: #dc2626;\n}\n\n#status {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #065f46;\n}',

 js: '// JavaScript using AbortController to cancel a fetch request\nlet controller;\n\nfunction fetchData() {\n  controller = new AbortController();\n  const signal = controller.signal;\n\n  document.getElementById("status").textContent = "Fetching data...";\n\n  fetch("https://jsonplaceholder.typicode.com/posts", { signal })\n    .then(response => response.json())\n    .then(data => {\n      document.getElementById("status").textContent = `Fetched ${data.length} posts.`;\n      console.log("Data fetched:", data);\n    })\n    .catch(error => {\n      if (error.name === "AbortError") {\n        document.getElementById("status").textContent = "Fetch aborted!";\n        console.warn("Fetch was aborted.");\n      } else {\n        document.getElementById("status").textContent = "Fetch error occurred.";\n        console.error("Fetch error:", error);\n      }\n    });\n}\n\nfunction abortFetch() {\n  if (controller) {\n    controller.abort();\n  }\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("AbortController demo is ready.");\n});'
};

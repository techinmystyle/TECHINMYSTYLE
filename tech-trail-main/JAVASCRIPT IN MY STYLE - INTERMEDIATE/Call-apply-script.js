...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">call(), apply()</code> methods in JavaScript allow you to invoke functions with a specific <code>this</code> context and arguments. <code>call()</code> accepts arguments individually, while <code>apply()</code> accepts them as an array. They're commonly used for method borrowing, function context binding, inheritance patterns, or dynamically invoking functions with different contexts.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>call() and apply() Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="callapply-container">\n    <h1>call() and apply() Demo</h1>\n    <button class="btn" onclick="runCallApply()">Run call() and apply()</button>\n    <p id="callapply-result"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #ecfccb;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.callapply-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\n.callapply-container h1 {\n  margin-bottom: 1rem;\n  color: #166534;\n}\n\n.btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #65a30d;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.btn:hover {\n  background-color: #4d7c0f;\n}\n\n#callapply-result {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #365314;\n}',

  js: '// Function to be reused with call and apply\nfunction introduce(city, country) {\n  return `${this.name} is from ${city}, ${country}.`;\n}\n\nfunction runCallApply() {\n  const person = { name: "Bob" };\n\n  // Using call()\n  const callResult = introduce.call(person, "Paris", "France");\n\n  // Using apply()\n  const applyResult = introduce.apply(person, ["Berlin", "Germany"]);\n\n  const output = `Using call(): ${callResult}\\nUsing apply(): ${applyResult}`;\n  document.getElementById("callapply-result").textContent = output;\n  console.log(output);\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("call() and apply() demo is ready.");\n});'
};

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="bg-emerald-50 px-2 py-1 rounded mx-1 inline-block">Tree Traversal</code> in JavaScript refers to algorithms for visiting and processing all nodes in a tree data structure, including depth-first methods like pre-order, in-order, and post-order traversal, and breadth-first traversal using queues or recursion. It's commonly used for DOM manipulation, file system navigation, parsing nested data structures, implementing search algorithms, or processing hierarchical data where you need to visit every node in a specific order to perform operations or extract information.</span>
    </p>
</div>
  `;
...
const button = document.getElementById("traverseBtn");
...
button.addEventListener("click", () => {
  const traversalResult = dfs(tree);
  output.textContent = "DFS Traversal Order:\\n" + traversalResult.join(" → ");
});
`
};

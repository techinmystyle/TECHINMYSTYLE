...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Function Hoisting</code> in JavaScript is a behavior where function declarations are moved to the top of their containing scope during compilation, making them available throughout their entire scope even before their actual declaration in the code. It's commonly used for understanding execution context, debugging scope issues, organizing code structure, or leveraging the ability to call functions before they appear in the source code.</span>
    </p>
</div>
...
<head>
  ...
  <title>Function Hoisting Demo</title>
  <link rel="stylesheet" href="style.css" />
</head>
<body>
  <div class="container">
    <h1>Function Hoisting Demo</h1>
    <p>Click the button to see function hoisting in action.</p>
...
runDemoBtn.addEventListener('click', () => {
  ...
  // Calling function before its declaration - works due to hoisting
  addLog('Result of add(5, 3): ' + add(5, 3));
  ...
  // Uncommenting below will throw error because function expressions are not hoisted like declarations
  /*
  addExpr(5, 3); // ReferenceError: Cannot access 'addExpr' before initialization

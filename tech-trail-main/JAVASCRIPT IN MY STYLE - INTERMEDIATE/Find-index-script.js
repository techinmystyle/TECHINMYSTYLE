...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">find(), findIndex()</code> methods in JavaScript search arrays for the first element that satisfies a provided testing function, with <code>find()</code> returning the element itself and <code>findIndex()</code> returning its index position. They're commonly used for data lookup, element retrieval, search operations, conditional element access, or locating specific items in arrays based on complex criteria without iterating through the entire array manually.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>JavaScript find() and findIndex() Demo</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="find-container">\n    <h1>Array find() and findIndex() Demo</h1>\n    <p id="findResult"></p>\n    <p id="findIndexResult"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #e0f7fa;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.find-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 20px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\np {\n  font-weight: bold;\n  color: #00796b;\n  margin-top: 1rem;\n}',

  js: '// JavaScript find() and findIndex() Example\nconst users = [\n  { id: 1, name: "Alice" },\n  { id: 2, name: "Bob" },\n  { id: 3, name: "Charlie" },\n  { id: 4, name: "Diana" }\n];\n\n// find() returns the first element that matches the condition\nconst foundUser = users.find(user => user.id === 3);\n\n// findIndex() returns the index of the first element that matches the condition\nconst foundIndex = users.findIndex(user => user.name === "Bob");\n\nconst findResult = document.getElementById("findResult");\nconst findIndexResult = document.getElementById("findIndexResult");\n\nfindResult.textContent = foundUser ? `Found user: ${foundUser.name} (ID: ${foundUser.id})` : "User not found.";\nfindIndexResult.textContent = foundIndex !== -1 ? `Found index of Bob: ${foundIndex}` : "User not found.";\n\nconsole.log("Found user:", foundUser);\nconsole.log("Found index:", foundIndex);\n'
};

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">BigInt</code> in JavaScript is a primitive data type that can represent integers with arbitrary precision, beyond the safe integer limit of regular numbers. They're commonly used for handling large integers in cryptography, financial calculations, timestamps with high precision, or any scenario requiring mathematical operations on very large whole numbers.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>BigInt Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="bigint-container">\n    <h1>BigInt Demo</h1>\n    <button class="bigint-btn" onclick="useBigInt()">Show BigInt</button>\n    <p id="bigint-result"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #fef2f2;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.bigint-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\n.bigint-container h1 {\n  margin-bottom: 1rem;\n  color: #991b1b;\n}\n\n.bigint-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #dc2626;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.bigint-btn:hover {\n  background-color: #b91c1c;\n}\n\n#bigint-result {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #7f1d1d;\n}',

  js: '// JavaScript example demonstrating BigInt\nfunction useBigInt() {\n  const regularNumber = Number.MAX_SAFE_INTEGER;\n  const bigIntNumber = BigInt(regularNumber) + 10n;\n  const result = `Regular Max Safe Integer: ${regularNumber}\\nBigInt Value After +10n: ${bigIntNumber}`;\n\n  document.getElementById("bigint-result").textContent = result;\n  console.log("BigInt used:", result);\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("BigInt demo ready.");\n});'
};

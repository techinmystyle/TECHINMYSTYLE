...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">getElementById / querySelector</code> methods in JavaScript are DOM selection methods where <code>getElementById()</code> selects elements by their ID attribute and <code>querySelector()</code> selects the first element matching a CSS selector. They're commonly used for DOM manipulation, element selection, event handling, content updates, form processing, or accessing specific HTML elements to modify their properties, content, or behavior dynamically.</span>
    </p>
</div>
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>getElementById vs querySelector</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="selector-container">\n    <h1>DOM Selector Demo</h1>\n    <input type="text" id="myInput" placeholder="Type something...">\n    <button id="getBtn">Get Value</button>\n    <p id="output"></p>\n    <p class="output2"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #e0f2fe;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.selector-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\ninput {\n  padding: 0.5rem;\n  font-size: 1rem;\n  width: 200px;\n  margin-bottom: 1rem;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #0284c7;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n}\n\nbutton:hover {\n  background-color: #0369a1;\n}\n\n#output, .output2 {\n  margin-top: 1rem;\n  color: #1e3a8a;\n  font-weight: bold;\n}',

  js: '// DOM Selection Example\nconst button = document.getElementById("getBtn");\n\nbutton.addEventListener("click", () => {\n  // Using getElementById\n  const inputVal1 = document.getElementById("myInput").value;\n  document.getElementById("output").textContent = `getElementById: ${inputVal1}`;\n\n  // Using querySelector\n  const inputVal2 = document.querySelector("#myInput").value;\n  document.querySelector(".output2").textContent = `querySelector: ${inputVal2}`;\n\n  console.log("getElementById:", inputVal1);\n  console.log("querySelector:", inputVal2);\n});'
};

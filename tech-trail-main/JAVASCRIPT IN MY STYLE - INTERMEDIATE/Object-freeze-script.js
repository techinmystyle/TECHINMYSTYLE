...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Object.freeze()</code> method in JavaScript makes an object immutable by preventing new properties from being added, existing properties from being removed or modified, and the object's prototype from being changed, creating a shallow freeze. It's commonly used for creating constants, protecting configuration objects, implementing immutable data patterns, preventing accidental mutations, or ensuring data integrity in functional programming approaches where objects should remain unchanged.</span>
    </p>
</div>
...
<head>
  ...
  <title>Object.freeze() Demo</title>
  <link rel="stylesheet" href="style.css" />
</head>
<body>
  <div class="container">
    <h1>Object.freeze() Method Demo</h1>
    <p>Shows how Object.freeze() prevents modifications to an object.</p>
    
    <button id="freezeBtn">Freeze Object and Modify</button>
...
.output-box {
  ...
  js: `const freezeBtn = document.getElementById('freezeBtn');
...
freezeBtn.addEventListener('click', () => {
  ...
  outputLog.textContent = 'Initial object:\\n' + JSON.stringify(obj, null, 2) + '\\n\\n';

  // Freeze the object
  Object.freeze(obj);
  outputLog.textContent += 'Object.freeze(obj) called.\\n';
  ...
  outputLog.textContent += 'After attempts to modify the object:\\n' + JSON.stringify(obj, null, 2) + '\\n';

  // Explanation
  outputLog.textContent += '\\nNote: Object.freeze() prevents modifications, additions, and deletions on the object.';
});`
};

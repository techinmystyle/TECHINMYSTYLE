...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">REST vs SOAP</code> comparison in JavaScript involves two different web service architectures: REST (Representational State Transfer) uses simple HTTP methods and JSON/XML for lightweight, stateless communication, while SOAP (Simple Object Access Protocol) uses XML messaging with strict standards and built-in security features. They're commonly used for different scenarios - REST for modern web APIs, mobile applications, and microservices due to simplicity, while SOAP for enterprise applications requiring strict security, transactions, and formal contracts.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>REST vs SOAP</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="api-container">\n    <h1>REST vs SOAP</h1>\n    <div class="tabs">\n      <button id="restBtn">REST API</button>\n      <button id="soapBtn">SOAP API</button>\n    </div>\n    <div id="info" class="info-box"></div>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #f9fafb;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.api-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  max-width: 500px;\n}\n\n.tabs button {\n  padding: 0.6rem 1.2rem;\n  margin: 0.5rem;\n  border: none;\n  border-radius: 5px;\n  cursor: pointer;\n  font-size: 1rem;\n  background-color: #e5e7eb;\n  color: #1f2937;\n}\n\n.tabs button:hover {\n  background-color: #d1d5db;\n}\n\n.info-box {\n  margin-top: 1.5rem;\n  text-align: left;\n  font-size: 0.95rem;\n  color: #374151;\n  background-color: #f3f4f6;\n  padding: 1rem;\n  border-radius: 8px;\n}’',

  js: '// REST vs SOAP Explanation\nconst restBtn = document.getElementById("restBtn");\nconst soapBtn = document.getElementById("soapBtn");\nconst info = document.getElementById("info");\n\nrestBtn.addEventListener("click", () => {\n  info.innerHTML = `\n    <h3>REST (Representational State Transfer)</h3>\n    <ul>\n      <li>Uses HTTP methods: GET, POST, PUT, DELETE</li>\n      <li>Data typically exchanged in JSON format</li>\n      <li>Lightweight and faster</li>\n      <li>Stateless communication</li>\n      <li>Commonly used in modern web and mobile apps</li>\n    </ul>`;\n});\n\nsoapBtn.addEventListener("click", () => {\n  info.innerHTML = `\n    <h3>SOAP (Simple Object Access Protocol)</h3>\n    <ul>\n      <li>Protocol-based, uses XML for messaging</li>\n      <li>Built-in error handling and strict standards</li>\n      <li>Supports complex operations and transactions</li>\n      <li>Used in enterprise systems and legacy services</li>\n      <li>Heavier than REST, but more secure in some cases</li>\n    </ul>`;\n});'
};

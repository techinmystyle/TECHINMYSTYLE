...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Object-Oriented Programming</code> in JavaScript is a programming paradigm that organizes code around objects and classes, implementing concepts like encapsulation, inheritance, and polymorphism using ES6 classes, prototypes, and constructor functions. It's commonly used for building scalable applications, code organization, modeling real-world entities, creating reusable components, or structuring complex systems where objects represent entities with properties and behaviors that interact with each other.</span>
    </p>
</div>
  `;
...
<head>
  ...
  <title>OOP in JavaScript Demo</title>
  <link rel="stylesheet" href="style.css" />
</head>
<body>
  <div class="container">
    <h1>Object-Oriented Programming (OOP) Demo</h1>
    <p>This demo demonstrates classes, objects, inheritance, and methods in JavaScript.</p>

    <button id="runOOPBtn">Run OOP Demo</button>
...
.output-box {
  ...
  js: `const runOOPBtn = document.getElementById('runOOPBtn');
const outputLog = document.getElementById('outputLog');

runOOPBtn.addEventListener('click', () => {
  ...
  // Create instances
  const person1 = new Person('BASHA RAM', 25);
  const student1 = new Student('Alex', 22, 'Computer Science');

  // Log outputs
  outputLog.textContent += person1.greet() + '\\n';
  outputLog.textContent += student1.greet() + '\\n';
  outputLog.textContent += student1.study() + '\\n';

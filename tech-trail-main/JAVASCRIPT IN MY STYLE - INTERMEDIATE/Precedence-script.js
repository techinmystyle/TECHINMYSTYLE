...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Precedence</code> in JavaScript refers to operator precedence, which determines the order in which operators are evaluated in expressions, with higher precedence operators like multiplication and division being evaluated before lower precedence operators like addition and subtraction. It's commonly used for understanding expression evaluation, avoiding calculation errors, writing clear mathematical expressions, debugging complex formulas, or ensuring that operations are performed in the intended order without relying solely on parentheses.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Operator Precedence</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="precedence-container">\n    <h1>Operator Precedence</h1>\n    <button id="calculateBtn">Calculate</button>\n    <pre id="output"></pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #fef9c3;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.precedence-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #facc15;\n  color: black;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n  margin-top: 1rem;\n}\n\nbutton:hover {\n  background-color: #eab308;\n}\n\npre {\n  margin-top: 1rem;\n  background-color: #fef08a;\n  color: #713f12;\n  padding: 1rem;\n  border-radius: 8px;\n  text-align: left;\n}',

  js: '// Operator Precedence Example\nconst button = document.getElementById("calculateBtn");\nconst output = document.getElementById("output");\n\nbutton.addEventListener("click", () => {\n  const result1 = 5 + 3 * 2;      // 3 * 2 = 6, then 5 + 6 = 11\n  const result2 = (5 + 3) * 2;    // 5 + 3 = 8, then 8 * 2 = 16\n  const result3 = 10 - 4 + 2;     // Left to right: 6 + 2 = 8\n  const result4 = 10 - (4 + 2);   // 4 + 2 = 6, then 10 - 6 = 4\n\n  const text = `Results of different operations:\n\n5 + 3 * 2       = ${result1}\n(5 + 3) * 2     = ${result2}\n10 - 4 + 2      = ${result3}\n10 - (4 + 2)    = ${result4}`;\n\n  output.textContent = text;\n  console.log("Operator precedence results displayed.");\n});'
};

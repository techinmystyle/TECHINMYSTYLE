...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">bind()</code> method in JavaScript creates a new function with a specific <code>this</code> context and optionally pre-filled arguments. It's commonly used for event handlers, callback functions, method borrowing, partial application, or any scenario where you need to control the execution context of a function.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>bind() Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="bind-container">\n    <h1>bind() Demo</h1>\n    <button class="bind-btn" onclick="useBindMethod()">Run bind()</button>\n    <p id="bind-result"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: sans-serif;\n  background-color: #f0fdf4;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.bind-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\n.bind-container h1 {\n  margin-bottom: 1rem;\n  color: #14532d;\n}\n\n.bind-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #16a34a;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.bind-btn:hover {\n  background-color: #15803d;\n}\n\n#bind-result {\n  margin-top: 1rem;\n  font-weight: bold;\n  color: #166534;\n}',

  js: '// Demonstration of bind() method in JavaScript\nfunction greetBind() {\n  return `Hello, my name is ${this.name}`;\n}\n\nfunction useBindMethod() {\n  const person = { name: "Bob" };\n  const boundGreet = greetBind.bind(person);\n  const message = boundGreet();\n  document.getElementById("bind-result").textContent = message;\n  console.log("bind() method used:", message);\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("bind() demo is ready.");\n});'
};

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">Final Class/Methods</code> concept in JavaScript refers to preventing inheritance or method overriding, though not natively supported, it can be implemented using techniques like Object.freeze(), private fields, or design patterns to create immutable classes and methods. It's commonly used for API design, security enforcement, preventing unintended modifications, ensuring class integrity, or creating stable base classes that shouldn't be extended or altered.</span>
    </p>
</div>
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>Simulating Final Class and Method</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="final-container">\n    <h1>Final Class & Method Demo</h1>\n    <p id="output"></p>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #fef3c7;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.final-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 20px rgba(0, 0, 0, 0.1);\n  text-align: center;\n}\n\n#output {\n  margin-top: 1rem;\n  color: #92400e;\n  font-weight: bold;\n}',

  js: '// Simulating Final Class and Method in JavaScript\nclass Vehicle {\n  constructor(name) {\n    this.name = name;\n  }\n\n  // Final method simulation\n  start() {\n    return `${this.name} is starting.`;\n  }\n}\n\n// Make the "start" method non-writable and non-configurable to prevent overriding\nObject.defineProperty(Vehicle.prototype, "start", {\n  writable: false,\n  configurable: false,\n});\n\n// Freeze the class constructor to prevent subclassing (not fully enforceable in JS)\nObject.freeze(Vehicle);\n\n// Trying to extend the class (overriding start will fail silently or throw in strict mode)\nclass Car extends Vehicle {\n  start() {\n    return "Car start method overridden!";\n  }\n}\n\nconst output = document.getElementById("output");\nconst myVehicle = new Vehicle("Truck");\nconst myCar = new Car("Sedan");\n\n// Output results\noutput.textContent = myVehicle.start() + "\\n" + myCar.start();\n\nconsole.log("Vehicle start:", myVehicle.start());\nconsole.log("Car start:", myCar.start());\n',
};

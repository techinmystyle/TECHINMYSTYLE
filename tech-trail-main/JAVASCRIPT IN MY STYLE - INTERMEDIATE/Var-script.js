...
<div class="flex items-start">
    ...
    <p>
        <span><code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">var</code> is a keyword used to declare variables in JavaScript with function scope. Unlike <code class="bg-gray-50 px-1 rounded">let</code> and <code class="bg-gray-50 px-1 rounded">const</code>, variables declared with <code class="bg-gray-50 px-1 rounded">var</code> are hoisted and can be redeclared, which may lead to unexpected behavior in modern JavaScript development.</span>
    </p>
</div>
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>var Keyword Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="var-container">\n    <h1>JavaScript var Keyword</h1>\n    <button id="runBtn">Run Code</button>\n    <pre id="output">Click to see how var works.</pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Arial, sans-serif;\n  background-color: #fff7ed;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n  margin: 0;\n}\n\n.var-container {\n  background-color: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  max-width: 600px;\n}\n\nbutton {\n  padding: 0.6rem 1.2rem;\n  background-color: #f97316;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  font-size: 1rem;\n  cursor: pointer;\n  margin-top: 1rem;\n}\n\nbutton:hover {\n  background-color: #ea580c;\n}\n\n#output {\n  margin-top: 1rem;\n  font-family: monospace;\n  text-align: left;\n  background-color: #ffedd5;\n  padding: 1rem;\n  border-radius: 5px;\n  color: #7c2d12;\n  white-space: pre-wrap;\n}',

  js: '// var Example\nconst button = document.getElementById("runBtn");\nconst output = document.getElementById("output");\n\nbutton.addEventListener("click", () => {\n  output.textContent = "";\n\n  var x = 10;\n  if (true) {\n    var x = 20; // same variable due to function/global scope\n    output.textContent += "Inside block: x = " + x + "\\n";\n  }\n  output.textContent += "Outside block: x = " + x;\n});'
};

...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">BOM (Browser Object Model)</code> in JavaScript provides access to browser-specific objects and functionality outside of the document content. It's commonly used for window manipulation, navigation control, browser information detection, popup management, or interacting with browser features like history, location, and screen properties.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  html: '<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n  <title>BOM Example</title>\n  <link rel="stylesheet" href="style.css">\n</head>\n<body>\n  <div class="bom-container">\n    <h1>BOM Demo</h1>\n    <button class="bom-btn" onclick="showBOMInfo()">Show BOM Info</button>\n    <pre id="bom-result"></pre>\n  </div>\n  <script src="script.js"></script>\n</body>\n</html>',

  css: 'body {\n  font-family: Verdana, sans-serif;\n  background-color: #e0f2fe;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 100vh;\n}\n\n.bom-container {\n  background: white;\n  padding: 2rem;\n  border-radius: 10px;\n  box-shadow: 0 8px 20px rgba(0, 0, 0, 0.1);\n  text-align: center;\n  max-width: 90%;\n}\n\n.bom-container h1 {\n  margin-bottom: 1rem;\n  color: #075985;\n}\n\n.bom-btn {\n  padding: 0.6rem 1.2rem;\n  background-color: #0284c7;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 1rem;\n  transition: background-color 0.3s ease;\n}\n\n.bom-btn:hover {\n  background-color: #0369a1;\n}\n\n#bom-result {\n  margin-top: 1rem;\n  color: #0c4a6e;\n  text-align: left;\n  white-space: pre-wrap;\n}',

  js: '// Demonstrating Browser Object Model (BOM)\nfunction showBOMInfo() {\n  const info = `Location: ${window.location.href}\\nNavigator: ${navigator.userAgent}\\nOnline: ${navigator.onLine}\\nScreen Width: ${screen.width}\\nScreen Height: ${screen.height}`;\n\n  document.getElementById("bom-result").textContent = info;\n  console.log("BOM information displayed.");\n}\n\ndocument.addEventListener("DOMContentLoaded", () => {\n  console.log("BOM demo is ready.");\n});'
};

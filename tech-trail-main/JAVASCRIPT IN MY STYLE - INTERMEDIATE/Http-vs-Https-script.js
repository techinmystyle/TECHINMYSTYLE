...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">HTTP vs HTTPS</code> in JavaScript development refers to the difference between unsecured (HTTP) and secured (HTTPS) communication protocols, where HTTPS encrypts data transmission using SSL/TLS certificates for secure client-server communication. It's commonly used for security implementation, API communication, data protection, authentication systems, or ensuring secure transmission of sensitive information like user credentials, payment data, and personal information in web applications.</span>
    </p>
</div>
  `;
...
const defaultCode = {
  ...
  js: '// HTTP vs HTTPS Explanation\nconst protocolSelect = document.getElementById("protocolSelect");\nconst description = document.getElementById("description");\n\nprotocolSelect.addEventListener("change", () => {\n  const choice = protocolSelect.value;\n\n  if (choice === "http") {\n    description.textContent = "HTTP (Hypertext Transfer Protocol) is not secure. Data sent is in plain text, and can be intercepted.";\n  } else if (choice === "https") {\n    description.textContent = "HTTPS (Hypertext Transfer Protocol Secure) uses SSL/TLS encryption to secure data transfer between client and server.";\n  } else {\n    description.textContent = \"\";\n  }\n});'
};

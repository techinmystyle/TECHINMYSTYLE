...
<div class="flex items-start">
    ...
    <p>
        <span>The <code class="${randomColor.bg.replace('100', '50')} px-2 py-1 rounded mx-1 inline-block">URL API</code> in JavaScript provides a convenient way to parse, construct, normalize, and manipulate URLs using the <code class="bg-gray-50 px-1 rounded">URL</code> constructor. It allows easy access to URL components like <code class="bg-gray-50 px-1 rounded">hostname</code>, <code class="bg-gray-50 px-1 rounded">pathname</code>, <code class="bg-gray-50 px-1 rounded">searchParams</code>, and more—making it essential for client-side routing, query string manipulation, and API integrations.</span>
    </p>
</div>
  `;
...
<body>
  <div class="container">
    <h1>JavaScript URL API</h1>
    <p>Enter a full URL below and click "Parse URL" to see its components.</p>
    <input type="text" id="urlInput" placeholder="https://example.com:8080/page?query=123#section" />
...
function parseURL() {
  ...
  try {
    ...
    outputLog.textContent = 'Invalid URL. Please enter a valid one.';
  }
}`
};
